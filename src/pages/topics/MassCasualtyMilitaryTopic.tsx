  ...
  return (
    <TopicTemplate
      ...
      keyPoints={[
        ...
        { text: "Triage Sieve (walking? breathing? RR? CRT/pulse?) → categorises P1/P2/P3/P4 within 30 s per casualty. RR <10 or >30 = P1 (current NARU 2021 threshold; legacy MIMMS uses >29). Triage Sort uses TRTS for in-hospital re-triage.", cites: ["NARU Triage Sieve 2021", "MIMMS 4e", "BJA Educ Major Incident 2017"] },
