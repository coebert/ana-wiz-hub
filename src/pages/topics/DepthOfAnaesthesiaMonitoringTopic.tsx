    ...
    <TopicTemplate
          ...
          <div className="overflow-x-auto mb-4">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-muted-foreground">
                ...
                <tr className="border-b border-border"><td className="py-2 font-medium text-foreground">Alpha (α)</td><td>8–13 Hz</td><td>Relaxed, eyes closed. Prominent over occipital cortex. 'Alpha anteriorisation' seen with anaesthetic induction (see below).</td></tr>
      ...
      <section className="space-y-6 mb-10">
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              { title: "Age & Drug Interactions", detail: "Neonates and infants have different baseline EEG patterns. Elderly patients have greater brain sensitivity and altered pharmacokinetics, so lower propofol effect-site concentrations commonly achieve the same BIS/Entropy target of 40–60. The Marsh TCI model does not directly incorporate age; pEEG-guided titration is therefore especially useful to avoid overdose. Opioids alone cause minimal EEG change because pEEG primarily reflects hypnotic depth." },
          ...
          <p className="mt-3 text-sm text-muted-foreground"><InlineRef topicId="depth-of-anaesthesia" refLabel="BJA 2003 Age Propofol" /> A sudden unexplained fall in BIS or Entropy can be a surrogate warning of <strong>global cerebral hypoperfusion</strong>: reduced oxygen delivery suppresses cerebral metabolism during major haemorrhage, amniotic-fluid embolism or cardiac arrest, sometimes before conventional monitors clearly deteriorate. First exclude a drug bolus, hypothermia, excessive hypnotic depth, poor signal and the fall caused when neuromuscular blockade removes EMG artefact. <InlineRef topicId="depth-of-anaesthesia" refLabel="IJOA 2023 pEEG" /></p>
        </div>
        ...
        <section className="space-y-4 mb-10">
          <h2 className="text-2xl font-serif font-bold text-foreground">Alpha anteriorisation</h2>
          <p className="text-muted-foreground">
            <strong>Alpha anteriorisation</strong> is the characteristic EEG signature of induction with GABAergic anaesthetics such
            as propofol and the volatile agents. In the awake, resting, eyes-closed state alpha power (8–13 Hz) is maximal over the
            <strong> occipital</strong> cortex. As consciousness is lost, alpha power shifts <strong>frontally</strong>, generated by
            thalamocortical loops that become hyper-synchronised, while occipital alpha disappears. The appearance of this coherent
            frontal alpha oscillation, usually with superimposed slow-delta activity, is a reliable marker of the transition to
            unconsciousness — more informative than any single index number. On a <strong>density spectral array (DSA)</strong> it is
            seen as a prominent warm-coloured (red) band at roughly 10 Hz appearing across the frontal channels at induction; its
            loss during maintenance suggests lightening, while its replacement by widespread slow-wave activity and burst
            suppression suggests excessive depth. Ketamine and dexmedetomidine produce different signatures — ketamine gives
            beta-gamma activity without frontal alpha, and dexmedetomidine gives spindles resembling non-REM sleep.<InlineRef topicId="depth-of-anaesthesia" refLabel="Purdon et al. 2015" />
          </p>
          <h2 className="text-2xl font-serif font-bold text-foreground pt-2">EEG patterns, anaesthetic depth and postoperative delirium</h2>
          <p className="text-muted-foreground">
            The EEG states associated with delirium risk are <strong>prolonged burst suppression</strong> (any suppression ratio
            &gt; 0) and sustained deep slow-wave activity with loss of frontal alpha — patterns seen when anaesthetic dose exceeds
            requirement. The <strong>elderly and frail</strong>, and patients with pre-existing cognitive impairment, are most at
            risk; their EEG shows lower alpha power and more suppression at any given agent concentration, so age-blind dosing
            reliably produces excessive depth. The proposed mechanism is anaesthetic disruption of thalamocortical and
            frontoparietal networks, producing persistent deficits in attention and executive function after emergence. The
            evidence must be qualified: the association between low BIS/burst suppression and delirium is consistent, but
            EEG-guided titration has not conclusively prevented it — <strong>ENGAGES</strong> found no reduction in delirium with
            EEG-guided anaesthesia, and <strong>CODA</strong> similarly showed no benefit while confirming that cumulative time at
            low BIS was independently associated with delirium. Avoiding unnecessary depth remains rational practice rather than
            proven prophylaxis.<InlineRef topicId="depth-of-anaesthesia" refLabel="Purdon et al. 2015" />
          </p>
        </section>
