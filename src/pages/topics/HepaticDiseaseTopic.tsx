              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    ...
                    <li><strong>Nomenclature</strong>: HRS-AKI now replaces the old "type 1" HRS, and HRS-NAKI (non-AKI, comprising HRS-AKD and HRS-CKD) replaces "type 2" <InlineRef topicId="hepatic-disease" refLabel="EASL 2022 HRS" />.</li>
                    <li><strong>Diagnostic criteria</strong> (ICA 2015 / EASL 2018) — all must be present: (1) cirrhosis with ascites; (2) AKI by KDIGO/ICA criteria (creatinine rise ≥ 26.5 µmol/L within 48 h, or ≥ 50% above baseline within 7 days); (3) no sustained improvement after ≥ 2 days of diuretic withdrawal and volume expansion with 20% albumin 1 g/kg/day (max 100 g/day); (4) absence of shock; (5) no current/recent nephrotoxic drugs (NSAIDs, aminoglycosides, contrast); (6) no macroscopic structural kidney injury — proteinuria &lt; 500 mg/day, no microhaematuria (&lt; 50 RBC/HPF), normal renal ultrasound <InlineRef topicId="hepatic-disease" refLabel="Angeli ICA-AKI 2015" />.</li>
                    <li><strong>Pathophysiology</strong>: extreme splanchnic arterial vasodilatation from portal hypertension and nitric oxide release reduces effective arterial blood volume, triggering baroreceptor-mediated activation of the renin–angiotensin–aldosterone system, sympathetic nervous system and vasopressin release, causing intense renal cortical vasoconstriction; cirrhotic cardiomyopathy limits the compensatory rise in cardiac output; systemic inflammation and bacterial translocation contribute.</li>
                    <li><strong>Treatment</strong>: <strong>terlipressin 1 mg IV 4–6 hourly</strong> (or 2 mg/day by continuous infusion), increased to 2 mg 4–6 hourly if creatinine has not fallen by ≥ 25% after 2 days, together with <strong>20% human albumin</strong> (1 g/kg day 1, then 20–40 g/day), continued for up to 14 days or until full response (creatinine within 26.5 µmol/L of baseline); <strong>noradrenaline 0.5–3 mg/h</strong> is an acceptable ICU alternative, titrated to a MAP rise of 10–15 mmHg or MAP &gt; 80–85 mmHg <InlineRef topicId="hepatic-disease" refLabel="EASL 2022 HRS" />.</li>
                    <li><strong>Monitoring</strong>: hourly urine output, daily creatinine and sodium, fluid balance and body weight (albumin-related overload); watch for terlipressin ischaemic complications (digital, mesenteric, myocardial), hyponatraemia and pulmonary oedema — stop terlipressin if these occur.</li>
                    <li><strong>Role of RRT</strong>: a bridge to liver transplantation or to recovery from a reversible precipitant, not a treatment for HRS itself; liver transplantation is the only definitive therapy, with simultaneous liver-kidney transplant considered after prolonged dialysis dependence.</li>
                  </ul>
                </div>
                <div className="bg-card border border-border rounded-lg p-4">
            ...
            <section id="section-pharmacology-in-hepatic-impairment" className="scroll-mt-24">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li><strong>Induction</strong>: propofol induction dose reduced by <strong>40–50%</strong> in severe disease (increased volume of distribution, reduced protein binding raising free fraction, and increased receptor sensitivity from encephalopathy) with slow titration to effect; TCI models are not validated in cirrhosis, so use processed EEG monitoring instead <InlineRef topicId="hepatic-disease" refLabel="BJA Educ Liver Pharmacology" />.</li>
                    ...
                    <li><strong>Opioids</strong>: single fentanyl doses are safe (unchanged clearance for a bolus), but infusions accumulate through reduced hepatic blood flow and clearance; <strong>remifentanil is the opioid of choice</strong> as plasma/tissue esterase metabolism is organ-independent; morphine's half-life roughly doubles and its active metabolites accumulate further if renal function is also impaired; avoid codeine (unreliable CYP2D6 activation) and pethidine <InlineRef topicId="hepatic-disease" refLabel="BJA Educ Liver Pharmacology" />.</li>
                    <li><strong>Neuromuscular blockade</strong>: rocuronium's duration of action can double (~45 min extending to ~90 min) because of biliary excretion and a larger volume of distribution — quantitative train-of-four monitoring is mandatory and sugammadex reversal should be available; vecuronium and pancuronium are similarly prolonged; <strong>cisatracurium is the agent of choice</strong> as organ-independent Hofmann elimination is unaffected by hepatic function; suxamethonium may be modestly prolonged by reduced plasma cholinesterase synthesis <InlineRef topicId="hepatic-disease" refLabel="BJA Educ Liver 2010" />.</li>
                    <li><strong>Analgesia</strong>: paracetamol is safe at reduced dose in established stable cirrhosis — maximum 2 g/day in severe cirrhosis (or 3 g/day for short courses in mild disease per local guidance) — but avoid in acute liver failure, decompensation, active alcoholic hepatitis and malnutrition, where glutathione stores are depleted; <em>avoid NSAIDs</em> (renal and variceal bleeding risk); regional techniques where coagulation allows.</li>
                    <li><strong>Sedatives</strong>: reduce benzodiazepine dosing — impaired clearance and increased cerebral sensitivity (encephalopathy) markedly prolong effect.</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section id="section-perioperative-decompensation" className="scroll-mt-24">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li><strong>Definition</strong>: acute decompensation of chronic liver disease (with or without previously diagnosed cirrhosis) producing hepatic failure (jaundice and coagulopathy) plus one or more extrahepatic organ failures, with a 28-day mortality of at least 15%; distinct from simple decompensation, and characterised by systemic inflammation (raised white cell count and CRP, high cytokines) with immune paresis <InlineRef topicId="hepatic-disease" refLabel="Moreau CANONIC 2013" />.</li>
                    <li><strong>Diagnostic criteria</strong>: EASL-CLIF Consortium definition from the CANONIC study, using CLIF-SOFA/CLIF-C organ failure definitions across six systems — liver (bilirubin ≥ 205 µmol/L), kidney (creatinine ≥ 177 µmol/L or RRT), brain (West Haven grade III–IV encephalopathy), coagulation (INR ≥ 2.5), circulation (vasopressor requirement) and respiration (PaO₂/FiO₂ ≤ 200 or SpO₂/FiO₂ ≤ 214) <InlineRef topicId="hepatic-disease" refLabel="Moreau CANONIC 2013" />.</li>
                    <li><strong>Grades</strong>: Grade 1 — single renal failure, or single non-renal organ failure with renal dysfunction (creatinine 133–176 µmol/L) or grade I–II encephalopathy (28-day mortality ~20%); Grade 2 — two organ failures (~30–35%); Grade 3 — three or more organ failures (~75%, &gt; 90% with four or more).</li>
                    <li><strong>Precipitants</strong>: bacterial and fungal sepsis (especially SBP), active alcohol excess, acute viral hepatitis or hepatitis B flare, variceal haemorrhage, drug-induced injury, and surgery.</li>
                    <li><strong>Management</strong>: early recognition and CLIF-C ACLF scoring; prompt discussion with a specialist hepatology/transplant centre; aggressive search for and treatment of the precipitant (broad-spectrum antibiotics within 1 h for suspected sepsis, antivirals, alcohol withdrawal management); organ support (noradrenaline with terlipressin/albumin for circulatory failure, RRT, lung-protective ventilation, ammonia-directed management of encephalopathy); enteral nutrition with 1.2–1.5 g/kg/day protein; early assessment for liver transplantation, with reassessment of futility at 3–7 days since failure to improve by day 7 predicts very high mortality <InlineRef topicId="hepatic-disease" refLabel="EASL 2018 Decompensated" />.</li>
                  </ul>
                </div>
                <div className="bg-card border border-border rounded-lg p-4">
                  <h3 className="font-semibold text-foreground mb-2">Variceal Haemorrhage — Exact Management</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li><strong>Resuscitation</strong>: restrictive transfusion strategy, target <strong>Hb 70–80 g/L</strong> (over-transfusion raises portal pressure and precipitates rebleeding); permissive hypotension targeting <strong>MAP ~65 mmHg</strong> with lactate clearance as an endpoint; correct hypocalcaemia; avoid excessive crystalloid; correct thrombocytopenia/coagulopathy only if actively bleeding <InlineRef topicId="hepatic-disease" refLabel="Baveno VII 2022" />.</li>
                    <li><strong>Splanchnic vasoconstriction</strong>: <strong>terlipressin 2 mg IV bolus, then 1–2 mg IV 4-hourly</strong> for 2–5 days; watch for hyponatraemia, peripheral and myocardial ischaemia; octreotide/somatostatin are alternatives <InlineRef topicId="hepatic-disease" refLabel="AASLD 2012" />.</li>
                    <li><strong>Prophylactic antibiotics</strong>: IV ceftriaxone 1 g once daily for up to 7 days in every cirrhotic with GI bleeding — reduces infection, rebleeding and mortality <InlineRef topicId="hepatic-disease" refLabel="AASLD 2012" />.</li>
                    <li><strong>Endoscopy</strong>: within 12 h with <strong>band ligation as first-line</strong>; injection sclerotherapy or glue (cyanoacrylate for gastric varices) second-line <InlineRef topicId="hepatic-disease" refLabel="Baveno VII 2022" />.</li>
                    <li><strong>Airway protection</strong>: RSI with a cuffed endotracheal tube before endoscopy in active haematemesis, reduced consciousness or massive bleeding — full-stomach and aspiration precautions; large-bore IV access, blood/platelets available in theatre, vasopressor support ready, active warming, and correction of coagulopathy guided by viscoelastic testing rather than INR alone.</li>
                    <li><strong>Refractory bleeding — balloon tamponade</strong>: Sengstaken–Blakemore/Minnesota tube in an intubated patient as a bridge for no more than 24 h — confirm gastric balloon position radiographically before full inflation, inflate the gastric balloon (usually 250–500 mL air) and apply traction, use the oesophageal balloon only if bleeding persists and deflate it intermittently; complications include oesophageal rupture, mucosal pressure necrosis, aspiration and airway obstruction on displacement; self-expanding covered oesophageal metal stents are an alternative with lower complication rates.</li>
                    <li><strong>Rescue therapy</strong>: TIPSS for failed endoscopic control; pre-emptive ("early") TIPSS within 72 h (ideally 24 h) in high-risk patients (Child-Pugh C 10–13, or Child-Pugh B with active bleeding at endoscopy) improves survival; contraindications include severe hepatic encephalopathy, heart failure and pulmonary hypertension <InlineRef topicId="hepatic-disease" refLabel="EASL 2018 Decompensated" />.</li>
                  </ul>
                </div>
                <div className="bg-card border border-border rounded-lg p-4">
            ...
            <section id="section-viral-hepatitis-and-acute-liver-injury" className="scroll-mt-24">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <div className="bg-card border-2 border-clinical/40 rounded-lg p-4">
                  <h3 className="font-semibold text-foreground mb-2">Toxicology in Liver Disease</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li><strong>Principles</strong>: chronic liver disease alters toxicity in opposite directions — chronic alcohol use induces CYP2E1 and depletes glutathione, increasing conversion of paracetamol to the toxic metabolite NAPQI, while advanced cirrhosis impairs glucuronidation/sulfation and reduces synthetic reserve, so hepatic decompensation follows a smaller insult. Malnutrition further lowers glutathione stores.</li>
                    <li><strong>Paracetamol overdose — pathophysiology</strong>: therapeutic doses are conjugated by glucuronidation and sulfation; when these saturate, CYP2E1 generates NAPQI, which is detoxified by glutathione. Once glutathione falls below ~30% of normal, NAPQI binds hepatocyte proteins causing centrilobular necrosis.<InlineRef topicId="hepatic-disease" refLabel="NPIS Paracetamol 2012" /></li>
                    <li><strong>Treatment thresholds</strong>: the single UK nomogram line (100 mg/L at 4 h to 15 mg/L at 15 h) applies to all patients; in known chronic liver disease, chronic alcohol use, malnutrition or enzyme-inducing drugs the nomogram should be treated as unreliable and the threshold for treatment lowered. Follow TOXBASE for staggered or unknown-timing ingestions, where levels cannot be interpreted and acetylcysteine is started immediately.</li>
                    <li><strong>Indications for acetylcysteine (NAC) in liver disease</strong>: any credible overdose regardless of timing or reported dose, any staggered ingestion, any ALT rise, and any patient presenting &gt;8 h after ingestion — start NAC first and stop later if levels and ALT permit. NAC is given by the UK 2-bag regimen (100 mg/kg over 2 h then 200 mg/kg over 10 h); continue beyond the standard course while ALT is rising, INR &gt;1.3 or paracetamol remains detectable.</li>
                    <li><strong>King's College Criteria (paracetamol-induced acute liver failure)</strong> — refer/list for transplantation if arterial pH &lt;7.30 after adequate fluid resuscitation, <em>or</em> all three of INR &gt;6.5 (PT &gt;100 s), creatinine &gt;300 µmol/L and grade III–IV encephalopathy; arterial lactate &gt;3.5 mmol/L after early resuscitation (or &gt;3.0 after full resuscitation) is an additional early marker. Discuss with the regional liver unit before criteria are met, not after.<InlineRef topicId="hepatic-disease" refLabel="O'Grady King's Criteria 1989" /></li>
                    <li><strong>Supportive care</strong>: N-acetylcysteine, glucose infusion for hypoglycaemia, avoid all further hepatotoxins, sedation and ventilation with intracranial-pressure precautions in grade III–IV encephalopathy, and correct coagulopathy only for bleeding or procedures (INR is a prognostic marker).</li>
                    <li><strong>Other agents</strong>: salicylate toxicity produces a mixed respiratory alkalosis/metabolic acidosis and is worsened by hypoalbuminaemia (more free drug) — treat with urinary alkalinisation and haemodialysis at lower thresholds. Iron overdose causes direct hepatocellular necrosis and is more dangerous with pre-existing disease — chelate with desferrioxamine. Sodium valproate, anti-tuberculous drugs and herbal remedies are common precipitants of decompensation. All poisoning management should follow current TOXBASE advice with NPIS discussion in liver disease.</li>
                  </ul>
                </div>
              </div>
            </section>
