...
import { MACDiagram } from "@/components/diagrams/pharmacology/MACDiagram";
import { SynthesisBlock } from "@/components/topic/SynthesisBlock";
import { volatileAgentsQuiz } from "@/data/quizzes";
import VolatileAgentStructures from "@/components/diagrams/pharmacology/VolatileAgentStructures";
import SecondGasEffectDiagram from "@/components/diagrams/pharmacology/SecondGasEffectDiagram";
    ...
    <TopicTemplate
      ...
      coreConcepts={
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-serif font-bold text-foreground">Organ Protection & Preconditioning</h2>
            <p className="text-foreground/90 leading-relaxed mb-3">
