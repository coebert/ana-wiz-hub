        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside space-y-1 text-foreground/90 text-sm">
              ...
              <li><strong>Immediate care:</strong> stop digoxin, monitor continuously, check renal function, digoxin concentration and electrolytes, and correct hypokalaemia or hypomagnesaemia carefully. Serum concentrations confirm exposure but correlate poorly with clinical toxicity — sample at least 6 h post-dose, and treat the patient and ECG rather than the number, particularly in acute-on-chronic poisoning. Use atropine for symptomatic bradycardia, and lidocaine or phenytoin (historically) for ventricular arrhythmia alongside magnesium.</li>
