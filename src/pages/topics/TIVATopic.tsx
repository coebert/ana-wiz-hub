  ...
  return (
    <TopicTemplate
      ...
      <section className="space-y-6 mb-10">
        <div>
          <h2 className="text-2xl font-serif font-bold text-foreground mb-3">Principles of TIVA & TCI</h2>
        ...
        {/* Compartment Model Basics */}
        <div>
          <h2 className="text-2xl font-serif font-bold text-foreground mb-3">Pharmacokinetic Compartment Models</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        {/* Cp vs Ce targeting */}
        <div>
          <h2 className="text-2xl font-serif font-bold text-foreground mb-3">Plasma (Cp) vs Effect-Site (Ce) Targeting</h2>
          <div className="grid sm:grid-cols-2 gap-3">
      ...
      <section className="space-y-6 mb-10">
        <div>
          <h2 className="text-2xl font-serif font-bold text-foreground mb-3">Marsh vs Schnider — Key Differences</h2>
