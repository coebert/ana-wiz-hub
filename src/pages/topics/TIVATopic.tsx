              ...
              <CollapsibleSubsection title="Principles of TIVA & TCI" defaultOpen>
                <div className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    <div className="p-4 rounded-lg border border-border bg-secondary/30">
                      <p className="font-semibold text-foreground text-sm">Disadvantages &amp; Risks of TIVA</p>
                      <ul className="text-xs text-muted-foreground mt-1 list-disc list-inside space-y-1">
                        <li>National guidance sets the minimum safe standards for the technique: a dedicated, visible, anti-reflux-protected line, processed EEG monitoring whenever a neuromuscular blocking drug is used, and a documented plan for the emergency drug and pump failure <InlineRef topicId="tiva" refLabel="AoA TIVA Guidelines 2019" />.</li>
                        <li><strong className="text-foreground">No end-tidal confirmation of delivery:</strong> unlike a volatile agent there is no measured expired concentration, so a disconnected, tissued or leaking line, an occluded valve or an empty syringe can produce awareness with no alarm. This is the single most important structural disadvantage.</li>
                        <li><strong className="text-foreground">Awareness:</strong> NAP5 reported accidental awareness in roughly 1:8,000 TIVA cases versus about 1:135,000 with volatile maintenance, and TIVA with neuromuscular blockade was over-represented among reports.</li>
                        <li><strong className="text-foreground">Model inaccuracy:</strong> pharmacokinetic models carry a median performance error of the order of 20–30% and were derived in healthy adult volunteers, so they are least reliable in the obese, the elderly, the shocked, the pregnant, the very young and in cardiac output extremes — exactly the patients who most need accuracy.</li>
                        <li><strong className="text-foreground">Equipment and human factors:</strong> dedicated pumps and giving sets, correct model and covariate entry, and a visible anti-reflux-protected line are all required; wrong-model, wrong-weight and wrong-units errors are recognised critical incidents.</li>
                        <li><strong className="text-foreground">Venous access dependence:</strong> difficult or single peripheral access, extravasation or a fully drawn-up but disconnected line all threaten the whole technique; propofol also causes injection pain.</li>
                        <li><strong className="text-foreground">Pharmacological:</strong> propofol infusion syndrome with prolonged high-dose infusions, lipid load and hypertriglyceridaemia, hypotension and bradycardia (worse with remifentanil), remifentanil-induced acute tolerance and opioid-induced hyperalgesia, and no bronchodilator or MAC-sparing volatile effect.</li>
                        <li><strong className="text-foreground">Cost and workload:</strong> more expensive than low-flow sevoflurane, greater preparation time and drug wastage, and a higher training and familiarity requirement.</li>
                      </ul>
              ...
              <CollapsibleSubsection title="TIVA vs Volatile — Cardioprotection, Neurocognition &amp; Oncology">
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-lg border border-border">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      <strong>Immunomodulation:</strong> the perioperative period produces a transient, neuroendocrine- and cytokine-driven depression of cell-mediated immunity, and the maintenance agent appears to modulate it. Volatile agents up-regulate hypoxia-inducible factor 1α and insulin-like growth factor signalling, reduce natural-killer-cell number and cytotoxicity, shift the T-helper 1 to T-helper 2 balance, and promote tumour-cell migration and angiogenesis in vitro. Propofol instead inhibits cyclo-oxygenase-2 and prostaglandin E₂ production, preserves natural-killer-cell and cytotoxic T-cell function, attenuates the pro-inflammatory interleukin-6 and tumour necrosis factor α response and has antioxidant activity <InlineRef topicId="tiva" refLabel="J Clin Med 2023 Immunomodulation" />; opioids (particularly morphine at high dose) are separately immunosuppressive and pro-angiogenic, which is a further argument for regional analgesia and opioid sparing. Retrospective cohorts have suggested a survival advantage with TIVA, but the first large randomised trial in breast-cancer surgery (Cochrane/GA-CARE-type evidence) has not shown a difference in recurrence-free survival. Current guidance is that oncological outcome should <em>not</em> drive the choice of anaesthetic technique; minimising opioid, providing regional analgesia, avoiding hypothermia, transfusion and hyperglycaemia are more defensible interventions.
                    </p>
                  </div>
                </div>
              </CollapsibleSubsection>
              ...
              <CollapsibleSubsection title="Practical TIVA Setup & Safety">
                <div className="space-y-2">
                  {[
                    ...
                    { step: "Safe TIVA setup — intravenous access", detail: "Use a dedicated, well-secured cannula of adequate calibre, sited where it can be seen and inspected throughout the case. Never bury the cannula under drapes: undetected extravasation or disconnection is a recognised cause of accidental awareness. Keep the infusion line as short and low-compliance as possible and label it clearly at the patient end." },
                    { step: "Safe TIVA setup — Luer-lock connections", detail: "Every connection from syringe to cannula must be Luer-lock. Push-fit (slip) connectors can separate under the pressure generated by a syringe pump, silently interrupting delivery. Check each junction after connecting and again after any patient reposition or transfer." },
                    { step: "Safe TIVA setup — anti-syphon valve", detail: "A one-way, pressure-sensitive valve placed in the infusion limb. It prevents free (gravity) siphoning of drug from the syringe if the pump is positioned above the patient, if the syringe plunger loses its seal, or if the syringe is incorrectly loaded — any of which could deliver a large unintended propofol bolus." },
                    { step: "Safe TIVA setup — anti-reflux valve", detail: "A one-way valve on the carrier-fluid limb that stops drug refluxing back up the carrier line (or into another co-infused line) when the pump pressure exceeds carrier-line pressure. Without it a bolus of propofol or remifentanil can accumulate in the carrier line and later be flushed in as an uncontrolled bolus." },
                    { step: "Safe TIVA setup — carrier fluid", detail: "A slow-running crystalloid carrier keeps the line patent, confirms that the vein is working, and washes drug from the dead space of the connectors towards the patient. Join the drug line to the carrier as close to the cannula as possible to minimise dead space and delay between pump change and clinical effect." },
                    { step: "Safe TIVA setup — pump and programming checks", detail: "Double-check patient weight, age, height and sex, the drug and its concentration, the model chosen (Marsh/Schnider/Eleveld; Minto/Eleveld for remifentanil), and the targeting mode (Cp or Ce) before starting. Confirm the pump display, watch the volume infused as an independent check on delivery, and never programme from a syringe you have not personally verified." },
                    ...
                    { step: "Manual TIVA (without TCI pump)", detail: "Bristol/Roberts 10-8-6 regimen: induce with a propofol bolus ~1–2 mg/kg, then propofol 10 mg/kg/hr for 10 min → 8 mg/kg/hr for 10 min → 6 mg/kg/hr thereafter, which approximates a plasma concentration of about 3 µg/ml when combined with an opioid or nitrous oxide. It is a stepwise manual approximation of the same three-compartment behaviour a TCI pump computes continuously, so it does not adjust for age, weight beyond simple scaling, or infusion duration, and offers no decrement-time display. Alongside it run remifentanil 0.1–0.25 µg/kg/min (up to 0.5–1 µg/kg/min for intense stimulus) or an alfentanil/fentanyl bolus-and-infusion. Use it when no TCI pump is available, for transfer and remote-site anaesthesia, in children under 16 kg where Marsh/Schnider are not validated, and in ICU sedation. Awareness risk is higher: syringe-driver rate errors, no target display and no built-in decrement estimate mean processed EEG monitoring and a visible, anti-reflux-protected dedicated line are even more critical, and drug requirement must be re-checked at every change in stimulus." },
                  ].map((s) => (
