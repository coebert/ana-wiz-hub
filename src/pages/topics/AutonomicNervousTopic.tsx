          ...
          <ExamSection id="autonomic-syndromes" exams={[Exam.FINAL, Exam.FFICM]} curriculumCodes={["OA_BK_06"]}>
            <CollapsibleSubsection title="Clinical Syndromes of Autonomic Dysfunction">
              <div className="space-y-3 text-sm text-foreground/85">
                ...
                <p><strong>Obstructive sleep apnoea:</strong> each obstructive event produces enhanced parasympathetic activity during apnoea followed by a sympathetic surge with arousal and resumed breathing. Intermittent hypoxia, large negative intrathoracic-pressure swings, atrial stretch, inflammation and oxidative stress increase arrhythmic susceptibility, particularly atrial fibrillation. Repeated surges contribute to chronic hypertension, atrial enlargement and ventricular hypertrophy <InlineRef topicId="autonomic-nervous" refLabel="Chest 2017 OSA Arrhythmia" />.</p>
          ...
          <ExamSection id="neurotransmitters" exams={[Exam.PRIMARY, Exam.FINAL]} curriculumCodes={["CR_BK_05"]}>
            ...
            <p className="text-foreground/90 leading-relaxed mt-3">
             ...
             <div className="mt-4 rounded-lg border border-border p-4">
               <h3 className="font-semibold text-foreground">Autonomic Nervous System and Nociception</h3>
               <p className="mt-2 text-sm text-foreground/85 leading-relaxed">Noxious stimulation commonly activates sympathetic outflow, producing tachycardia, hypertension, diaphoresis and mydriasis. Nociception monitors attempt to quantify these responses in anaesthetised or non-communicative patients; the Surgical Pleth Index combines changes in pulse-wave amplitude and heartbeat interval. These signals are not specific for pain and are altered by hypovolaemia, vasoactive drugs, autonomic disease and anaesthetic depth, so no autonomic index replaces clinical assessment <InlineRef topicId="autonomic-nervous" refLabel="Anaesthesia 2015 Pain Markers" />.</p>
             </div>
            <div className="bg-card rounded-xl border border-border p-4 md:p-6 mt-4">
              <ANSPathwayDiagram />
            </div>
