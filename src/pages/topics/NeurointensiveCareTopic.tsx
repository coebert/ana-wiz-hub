    ...
    <>
      ...
      <section className="space-y-6">
        <ExamSection id="toc-tbi" exams={[Exam.FINAL, Exam.FFICM, Exam.EDIC]} className="scroll-mt-24">
          <CollapsibleSubsection title="Traumatic Brain Injury (TBI)" defaultOpen>
        ...
        <ExamSection id="toc-sodium" exams={[Exam.FINAL, Exam.FFICM, Exam.EDIC]} className="scroll-mt-24">
          <CollapsibleSubsection title="Sodium Disorders in Neuro-ICU: SIADH vs CSW vs DI">
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <ExamSection id="toc-icp" exams={[Exam.FINAL, Exam.FFICM, Exam.EDIC]} className="scroll-mt-24">
          <CollapsibleSubsection title="ICP Monitoring Devices">
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <ExamSection id="toc-gbs" exams={[Exam.FINAL, Exam.FFICM, Exam.EDIC]} className="scroll-mt-24">
          <CollapsibleSubsection title="Guillain-Barré Syndrome (GBS) — ICU Management">
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <ExamSection id="toc-myasthenic-crisis" exams={[Exam.FINAL, Exam.FFICM, Exam.EDIC]} className="scroll-mt-24">
          <CollapsibleSubsection title="Myasthenic Crisis — ICU Management">
          <p className="text-muted-foreground leading-relaxed mb-3">
