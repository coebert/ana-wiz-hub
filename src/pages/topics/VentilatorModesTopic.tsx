      ...
      coreConcepts={
        ...
        <ExamSection exams={[Exam.FINAL, Exam.FFICM]} className="scroll-mt-24">
          <section className="space-y-6">
            ...
            <div><h2 className="text-2xl font-serif font-bold text-foreground mb-3">Non-Invasive Ventilation</h2><p className="text-muted-foreground">NIV delivers positive pressure without a tracheal tube, principally CPAP or bilevel pressure support. Strong indications include acute hypercapnic COPD exacerbation and acute cardiogenic pulmonary oedema.</p><div className="mt-3 grid gap-3 md:grid-cols-2 text-sm text-muted-foreground"><div className="rounded-lg border border-border p-3"><strong className="text-foreground">Interfaces</strong><p className="mt-1">An oronasal/full-face mask gives effective acute support but risks pressure injury, claustrophobia and aspiration. A nasal mask is more comfortable and permits speech but leaks through the mouth and is less suitable in severe acute failure. A helmet reduces facial pressure injury and may improve tolerance, but has large compliant internal volume, noise, CO₂ rebreathing and slower triggering/pressurisation.</p></div><div className="rounded-lg border border-border p-3"><strong className="text-foreground">Ventilator and starting settings</strong><p className="mt-1">Dedicated NIV ventilators use single-limb intentional-leak circuits and superior compensation for large variable leaks, preserving trigger and cycling. Modern ICU ventilators use dual-limb circuits with an NIV algorithm and provide closer FiO₂ and monitoring. In COPD, a typical start is IPAP 10–12 and EPAP 4–5 cmH₂O; titrate pressure support to tidal volume, comfort and CO₂ clearance.</p></div><div className="rounded-lg border border-border p-3"><strong className="text-foreground">Monitor response</strong><p className="mt-1">Reassess respiratory rate, accessory-muscle use, synchrony, conscious level, oxygenation, pH and PaCO₂ within 1–2 hours. Improving distress, falling respiratory rate and rising pH indicate success; worsening acidosis, hypoxaemia, agitation, exhaustion or GCS demands prompt intubation rather than prolonged NIV.</p></div><div className="rounded-lg border border-border p-3"><strong className="text-foreground">Contraindications</strong><p className="mt-1">Do not use NIV with respiratory arrest, fixed upper-airway obstruction, uncontrolled vomiting/inability to protect the airway, or major facial trauma preventing a seal. GCS &lt;8, copious secretions, severe haemodynamic instability, recent upper-GI surgery and agitation are strong relative contraindications requiring expert review and an immediate intubation plan.</p></div></div><p className="mt-3 text-sm text-muted-foreground">Interface fit determines comfort and leak; continually reassess gas exchange, work of breathing, synchrony and need for intubation. <InlineRef topicId="ventilator-modes" refLabel="Intensive Care Med 2012 NIV" /></p></div>
