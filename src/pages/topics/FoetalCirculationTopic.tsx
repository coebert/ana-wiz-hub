            ...
            <div className="mt-4 space-y-3 text-sm text-muted-foreground leading-relaxed">
              <div className="rounded-lg border border-border p-4">
                ...
                <ul className="mt-1 space-y-1 list-disc list-inside">
                  ...
                  <li><strong>Ventilation:</strong> recruit and maintain optimal lung volume — atelectasis and over-distension both raise PVR. Use gentle conventional ventilation aiming for PaCO₂ 5.0–6.0 kPa and pH 7.35–7.45; escalate to <strong>high-frequency oscillatory ventilation</strong> to recruit at lower tidal excursion and limit volutrauma, particularly in meconium aspiration and congenital diaphragmatic hernia. Give surfactant for parenchymal disease. Maintain normothermia; correct clinically important metabolic acidosis while treating its cause, with sodium bicarbonate reserved for selected severe cases rather than routine alkalinisation.</li>
                  <li><strong>Pulmonary vasodilators:</strong> iNO 20 ppm first line; monitor methaemoglobin and inspired NO₂, then wean in small steps once oxygenation improves to avoid rebound pulmonary hypertension. If iNO fails or is unavailable — <strong>sildenafil</strong> orally or IV, inhaled <strong>iloprost</strong> or another prostacyclin analogue, and occasionally enteral <strong>bosentan</strong>; milrinone may help when RV dysfunction coexists.</li>
