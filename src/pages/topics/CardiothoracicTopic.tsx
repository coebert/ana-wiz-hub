                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-muted-foreground align-top">
                    {[
                      ...
                      { f: "Limitations / risks", a: "Requires extra cannulation (axillary access, technical complexity); risk of arterial dissection, embolism, malperfusion if pressure too high; right radial only monitors right hemisphere unless bilateral cannulation used.", b: "Limited oxygen delivery — most flow is shunted through AV connections; cerebral oedema if pressure >25 mmHg; shorter safe time; not a substitute for ASCP in long arrests." },
