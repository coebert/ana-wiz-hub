          ...
          <CollapsibleSubsection title="Pathophysiology of ARDS" defaultOpen>
            ...
            <div className="p-4 rounded-lg border border-border mt-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Acute right ventricular failure occurs in roughly <strong>22% (range 20–25%)</strong> of moderate-to-severe ARDS patients managed with protective ventilation. It arises from an acute rise in <strong>pulmonary vascular resistance</strong> driven by hypoxic pulmonary vasoconstriction, in-situ microthrombosis, and hypercapnia/acidosis, compounded by the high intrathoracic pressures generated by PEEP and driving pressure impeding RV ejection. Independent risk factors include <strong>infectious/sepsis-induced ARDS</strong> and a <strong>driving pressure &gt; 18 cmH₂O</strong>. Diagnosis is echocardiographic: RV dilatation (RV:LV end-diastolic area ratio &gt; 0.6), septal dyskinesia and paradoxical septal motion ("D-sign") in systole, with impaired longitudinal function shown by <strong>TAPSE &lt; 16 mm</strong>; regional apical sparing with a hypokinetic mid free wall (<strong>McConnell’s sign</strong>) suggests a superimposed acute pulmonary embolus rather than ARDS-related pulmonary vascular dysfunction alone. Its presence carries a marked prognostic penalty — 28-day mortality ~60% vs ~36% without it. Management follows directly from the mechanism: limit driving pressure, avoid excessive PEEP and avoid the extremes of permissive hypercapnia, use prone positioning (which lowers PVR and improves RV function independent of oxygenation), and reserve inhaled nitric oxide or inhaled prostacyclin as selective pulmonary vasodilator rescue when overt RV failure is present, and manage the three RV determinants explicitly — <strong>preload</strong> (avoid fluid loading a distended RV; cautious diuresis or ultrafiltration once shock has resolved), <strong>afterload</strong> (driving pressure, PEEP, PaCO₂ ≈ 6 kPa and pH ≥ 7.30, prone positioning, selective inhaled vasodilator) and <strong>RV perfusion pressure</strong> (noradrenaline or vasopressin to keep MAP above RV systolic pressure, since RV coronary flow is systolic and fails when systemic pressure drops) — with early ECMO referral if RV failure is refractory.
              </p>
            </div>
        ...
        <ExamSection id="section-historical" className="scroll-mt-24" exams={[Exam.FINAL, Exam.FFICM, Exam.EDIC]}>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-lg border border-border bg-secondary/30">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                <strong>Physiological rationale:</strong> HFOV applies a high constant mean airway pressure with tiny oscillatory volumes (1–4 mL/kg) delivered at 3–15 Hz by a reciprocating piston/diaphragm, with active expiration. In principle this is the ideal ARDS strategy — the constant distending pressure recruits and holds open collapsed alveoli (raising end-expiratory lung volume above closing volume and improving oxygenation), while the minute oscillations almost abolish cyclical opening and closing (atelectrauma) and tidal overdistension (volutrauma), so lung-protective ventilation is taken to its logical extreme. Gas exchange occurs by bulk flow to proximal alveoli plus Taylor dispersion, pendelluft, asymmetric velocity profiles, cardiogenic mixing and molecular diffusion. <strong>Setting it up (historical):</strong> mean airway pressure was set about 5 cmH₂O above that on conventional ventilation and then titrated to keep SpO₂ 88–93% with FiO₂ &lt; 0.7, with frequency reduced to improve CO₂ clearance and amplitude titrated to visible chest wiggle <InlineRef topicId="ards" refLabel="Crit Care Med 2001 (HFOV in adults)" />. <strong>Why it failed in practice:</strong> the high mean airway pressure reduces venous return and increases RV afterload, and deep sedation with neuromuscular blockade is required — so oxygenation improves but haemodynamics and outcomes worsen. Two 2013 RCTs ended its routine adult use:
              </p>
