      ...
      <div className="prose prose-slate max-w-none">
        ...
        <section className="mb-10">
          ...
          <div className="rounded-lg bg-muted/30 border border-border p-4 mt-6 text-sm text-foreground/80">
            <p>
              <strong>Note:</strong> The clinical syndromes and management of acute kidney injury (KDIGO staging,
              contrast-induced AKI prevention, perioperative drug dosing in renal impairment, and renal replacement
              therapy) are covered in detail in the dedicated{" "}
