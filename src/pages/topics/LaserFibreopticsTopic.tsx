...
const workedExamples: WorkedExample[] = [
  {
    ...
    working:
      "CO₂ laser (10,600 nm) is fully absorbed by water → ignites PVC at low energies.\nFire triangle = oxidiser + fuel + ignition. PVC = fuel; CO₂ laser = ignition; O₂ ± N₂O = oxidiser (N₂O behaves as an oxidiser at temperatures generated by the laser).\nKey mitigations (per the Association of Anaesthetists / DAS shared-airway guidance and the OAA/DAS airway-fire algorithm): laser-safe (metal-bodied, e.g. Laser-Flex) ETT; deliver the lowest clinically appropriate FiO₂ — typically ≤ 0.30 in air to keep SpO₂ acceptable — with N₂O omitted; cuff filled with saline ± methylene blue; wet pledgets around the cuff; surgeon to use lowest effective laser power; have saline and a spare circuit ready.",
    answer:
      "Decline the original plan. Use a laser-resistant ETT, run the lowest FiO₂ that maintains adequate oxygenation (commonly ≤ 0.30) with N₂O omitted, fill the cuff with saline + dye, and follow the Association of Anaesthetists airway-fire drill if ignition occurs: stop ventilation and disconnect O₂, remove the burning tube, flood the field with saline, then mask-ventilate, re-intubate and perform bronchoscopy to assess thermal injury.",
