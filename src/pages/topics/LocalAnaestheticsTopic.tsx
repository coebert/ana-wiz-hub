      ...
      <div className="prose prose-slate max-w-none">
        <section className="mb-10">
          ...
          <p className="text-sm text-muted-foreground italic mt-2">
            Reference: Becker DE, Reed KL. Local anesthetics: review of pharmacological considerations. Anesth Prog, 2012;
            Peck TE, Hill SA. Pharmacology for Anaesthesia and Intensive Care, 5th edition.
          </p>
        </section>
