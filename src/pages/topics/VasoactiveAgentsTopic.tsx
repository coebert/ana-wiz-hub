...
import VasoactiveReceptorDiagram from "@/components/diagrams/pharmacology/VasoactiveReceptorDiagram";
import VasoactiveStructures from "@/components/diagrams/pharmacology/VasoactiveStructures";
import InotropeSignallingDiagram from "@/components/diagrams/pharmacology/InotropeSignallingDiagram";
      ...
      coreConcepts={
        ...
        <section className="mb-10">
          <ul className="text-foreground/90 space-y-1">
            ...
            <li><strong>Septic shock:</strong> current paediatric sepsis guidance recommends adrenaline or noradrenaline in preference to dopamine as first-line vasoactive support, starting them early (including via peripheral or intraosseous access at low concentration) if perfusion remains poor after 40–60 mL/kg of fluid. Adrenaline is conventionally chosen for “cold” low-output shock with high SVR, and noradrenaline for “warm” vasodilated shock <InlineRef topicId="vasoactive-agents" refLabel="SCCM Paediatric Sepsis 2020" /><InlineRef topicId="vasoactive-agents" refLabel="Curr Pediatr Rep 2023 Paediatric Sepsis" /></li>
            <li><strong>Second-line and adjuncts:</strong> add dobutamine or milrinone for low cardiac output with adequate perfusion pressure, vasopressin for catecholamine-refractory vasoplegia, and consider levosimendan in myocardial dysfunction; titrate to perfusion, lactate clearance and echocardiographic function rather than blood pressure alone <InlineRef topicId="vasoactive-agents" refLabel="Curr Pediatr Rep 2023 Paediatric Sepsis" /></li>
        ...
        <section className="mb-10">
          <h3 className="text-xl font-serif font-bold text-foreground">Tachyphylaxis and Catecholamine Resistance</h3>
          <p className="text-foreground/90 leading-relaxed mt-2">
            Escalating vasopressor requirements over hours to days are common in prolonged shock and reflect receptor-level
            desensitisation as well as unresolved pathology.
          </p>
          <ul className="text-foreground/90 space-y-1 mt-2">
            <li><strong>Mechanisms:</strong> agonist-occupied β- and α₁-adrenoceptors are phosphorylated by G-protein-coupled receptor kinases and bind β-arrestin, which uncouples them from Gs/Gq (desensitisation) and drives internalisation; sustained stimulation then reduces receptor gene transcription (downregulation). Depletion of noradrenaline from sympathetic nerve terminals contributes to tachyphylaxis with indirectly acting agents such as ephedrine and metaraminol.</li>
            <li><strong>Contributors in critical illness:</strong> acidosis (impairs receptor coupling), hypoxia, hypocalcaemia, hypothermia, hypothyroidism, relative adrenal insufficiency, excessive nitric oxide and prostacyclin production, and ATP-sensitive potassium channel activation in vascular smooth muscle.</li>
            <li><strong>Clinical clues:</strong> the same drug and dose produce progressively less effect; a bolus produces a transient response only; and the total noradrenaline requirement rises without a change in filling or cardiac output.</li>
            <li><strong>Classic example:</strong> the inotropic effect of a dobutamine infusion typically wanes after 48–72 h as β₁-receptors are internalised and downregulated, so either escalate the dose (accepting tachycardia and arrhythmia) or switch to a mechanism downstream of the receptor — a phosphodiesterase-3 inhibitor such as milrinone, or levosimendan — which retains effect despite receptor loss and during β-blockade.</li>
            <li><strong>Management:</strong> re-examine for uncontrolled source, hypovolaemia, tamponade, ischaemia or occult bleeding; correct pH, ionised calcium, magnesium and temperature; add a non-catecholamine pathway early (vasopressin, then angiotensin II or methylene blue) rather than escalating a single agonist; consider hydrocortisone in catecholamine-refractory septic shock; and reduce β-agonist exposure where possible, since it also drives tachyarrhythmia and hypermetabolism.</li>
            <li><strong>Note the exceptions:</strong> vasopressin and angiotensin II act through non-adrenergic receptors and do not show classic catecholamine tachyphylaxis, which is a major reason for combining pathways. Nitrate tolerance (GTN) and SNP tachyphylaxis have separate mechanisms — sulfhydryl depletion and cyanide accumulation respectively.</li>
          </ul>
        </section>
