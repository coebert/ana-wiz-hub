  ...
  return (
    <TopicTemplate
      ...
      keyPoints={[
        ...
        { text: "Post-operative visual loss (POVL) is associated with prone spine surgery (>6 h, large blood loss) and steep Trendelenburg robotic surgery — keep head neutral or above heart, avoid direct globe pressure, maintain MAP.", cites: ["BJA Educ PION 2017"] },
