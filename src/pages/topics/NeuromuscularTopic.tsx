          ...
          <ExamSection id="sequence" exams={[Exam.PRIMARY, Exam.FINAL]} curriculumCodes={["NA_BK_03"]}>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-border p-4">
                ...
                <p className="text-sm text-foreground/80 mt-1 leading-relaxed">
                   Channel opening allows Na⁺ and Ca²⁺ influx with K⁺ efflux—a net inward positive current producing a localised depolarisation—
            ...
            <div className="bg-secondary/30 rounded-lg p-4 border border-border">
              <p className="text-sm font-medium text-foreground">Conditions Affecting NM Transmission</p>
               <ul className="text-sm text-muted-foreground mt-2 space-y-1">
                 <li>• <strong>Myasthenia gravis</strong> — AChR, MuSK or LRP4 autoantibodies cause fatigable ocular, bulbar, limb or respiratory weakness. Diagnose with antibodies and electrophysiology: repetitive nerve stimulation typically gives a &gt;10% decrement; the edrophonium (Tensilon) test is now rarely used. Treat with pyridostigmine, corticosteroids or azathioprine; selected active AChR-antibody-positive disease may receive complement inhibition such as eculizumab or an FcRn antagonist such as efgartigimod. For anaesthesia, reduce and quantitatively monitor <Link to="/pharmacology/muscle-relaxants" className="text-pharmacology underline">non-depolariser</Link> doses, expect relative resistance to suxamethonium and avoid exacerbating drugs such as aminoglycosides and β-blockers <InlineRef topicId="neuromuscular" refLabel="Ther Adv Neurol Disord 2023 MG" />.</li>
                 <li>• <strong>Lambert–Eaton syndrome</strong> — antibodies against presynaptic P/Q-type voltage-gated Ca²⁺ channels impair ACh release; about half of cases are associated with small-cell lung cancer. The triad is proximal weakness, autonomic dysfunction (dry mouth or postural hypotension) and areflexia. CMAP is low at baseline but increases markedly, often &gt;100%, after maximal contraction or brief 50 Hz stimulation. Patients may be extremely sensitive to both depolarising and non-depolarising blockers, so consider regional anaesthesia and use quantitative monitoring <InlineRef topicId="neuromuscular" refLabel="NDT 2022 MG LEMS" />.</li>
            ...
            <div className="mt-4 rounded-lg border border-border p-4">
              ...
              <ul className="mt-3 list-disc pl-5 space-y-1 text-sm text-foreground/80">
                <li><strong>Acute cholinergic crisis</strong> — muscarinic excess (DUMBBELLS/SLUDGE: diarrhoea, urination, miosis, bronchorrhoea, bradycardia, emesis, lacrimation, salivation) plus nicotinic fasciculation and weakness.</li>
                 <li><strong>Intermediate syndrome</strong> — a distinct phase 24–96 h after exposure and after the acute cholinergic crisis, with prominent weakness of neck flexors, proximal limb muscles and respiratory muscles; ventilatory support is often required. Prolonged cholinesterase inhibition produces combined pre- and postsynaptic transmission failure. Repetitive nerve stimulation may evolve from decrement to increment before normalising. Treatment is supportive, centred on airway protection and mechanical ventilation <InlineRef topicId="neuromuscular" refLabel="Crit Care Med 1993 Intermediate Syndrome" />.</li>
