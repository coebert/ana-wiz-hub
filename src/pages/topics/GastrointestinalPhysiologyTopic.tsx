          ...
          <ExamSection id="gut-microbiome" exams={[Exam.FINAL, Exam.FFICM]} curriculumCodes={["CR_BK_06"]}>
            <CollapsibleSubsection title="The Gut Microbiome and Perioperative Significance">
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                <p><strong>Composition:</strong> around 10<sup>14</sup> organisms, dominated by <em>Firmicutes</em> and <em>Bacteroidetes</em> with smaller populations of <em>Actinobacteria</em>, <em>Proteobacteria</em> and <em>Verrucomicrobia</em>, plus archaea, fungi and viruses. Density rises from ~10<sup>3</sup>/mL in the stomach and duodenum to ~10<sup>11</sup>–10<sup>12</sup>/g in the colon, where anaerobes outnumber aerobes by around 1000:1.</p>
                <p><strong>Physiological roles:</strong> fermentation of non-digestible carbohydrate to short-chain fatty acids (butyrate is the primary colonocyte fuel and promotes tight-junction integrity and regulatory T cells; propionate and acetate enter hepatic gluconeogenesis and lipogenesis); synthesis of vitamin K and B-group vitamins; deconjugation and 7α-dehydroxylation of bile acids into secondary bile acids that signal via FXR and TGR5; conversion of dietary choline to trimethylamine (hepatic TMAO); drug and hormone metabolism (β-glucuronidase-mediated enterohepatic recycling, azoreduction of sulfasalazine, inactivation of digoxin by <em>Eggerthella lenta</em>); training of gut-associated lymphoid tissue and secretory IgA; and colonisation resistance by niche and nutrient competition, bacteriocins and a low-pH, bile-acid-rich luminal environment.</p>
                <p><strong>Gut–brain and gut–lung axes:</strong> microbial metabolites and vagal afferent signalling modulate serotonin synthesis (over 90% of body 5-HT is enteric), hypothalamic–pituitary–adrenal reactivity and pain perception; translocated products and metabolites shape alveolar immune tone, relevant to ventilator-associated pneumonia and ARDS.</p>
                <p><strong>Dysbiosis:</strong> loss of diversity with expansion of virulent organisms. Drivers include surgical stress and catecholamines, starvation and altered nutrition, opioids (delayed transit, mucosal barrier effects), proton-pump inhibitors, broad-spectrum antibiotics, mechanical bowel preparation, hypoperfusion, transfusion, hyperoxia and prolonged critical illness. The typical ICU pattern within 48–72 h is a low-diversity, pathogen-dominated flora — often a single <em>Enterococcus</em>, <em>Proteobacteria</em> or <em>Candida</em> "pathobiome" — with depletion of butyrate producers.</p>
                <p><strong>Mechanisms of harm:</strong> loss of colonocyte butyrate impairs mucosal energetics and barrier function; increased permeability permits translocation of bacteria and endotoxin into portal and lymphatic routes, amplifying systemic inflammation; and collagenase- and matrix-metalloproteinase-producing organisms (<em>Enterococcus faecalis</em>, <em>Pseudomonas aeruginosa</em>) degrade anastomotic collagen and activate host MMP-9.</p>
                <p><strong>Perioperative outcomes:</strong> dysbiosis is implicated in anastomotic leak, surgical-site and healthcare-associated infection, <em>Clostridioides difficile</em> colitis, ventilator-associated pneumonia, postoperative ileus and delirium <InlineRef topicId="gi-physiology" refLabel="BJS 2017 Microbiome" />.</p>
                <p><strong>Surgical stress and cancer surgery:</strong> the microbiome is a determinant of normal gastrointestinal physiology and modifies the physiological response to surgical stress; perioperative interventions (bowel preparation, antibiotics, fasting, opioids, transfusion) cause acute microbial shifts linked to anastomotic leak and pneumonia, and the microbiome is also implicated in carcinogenesis (<em>Fusobacterium nucleatum</em>, colibactin-producing <em>E. coli</em>, <em>enterotoxigenic Bacteroides fragilis</em>) and in the response to chemotherapy and immunotherapy <InlineRef topicId="gi-physiology" refLabel="BJS 2026 Microbiome Oncology" />.</p>
                <p><strong>Therapeutic manipulation:</strong> avoid unnecessary and prolonged antibiotics and PPIs; preserve enteral feeding; consider fibre-containing nutrition. Prebiotics, probiotics and synbiotics reduce infectious complications in network meta-analysis of elective abdominal surgery, with synbiotics ranked highest, but the evidence is heterogeneous and they are avoided in immunocompromised, pancreatitis and severely ill patients because of translocation and fungaemia risk <InlineRef topicId="gi-physiology" refLabel="Probiotics Meta-analysis 2017" />. Faecal microbiota transplantation is established only for recurrent <em>C. difficile</em> infection <InlineRef topicId="gi-physiology" refLabel="NICE FMT 2022" />. Selective digestive decontamination remains geographically divisive and is not standard UK practice.</p>
              </div>
            </CollapsibleSubsection>
          </ExamSection>

          <ExamSection id="eras-protocols" exams={[Exam.FINAL, Exam.FFICM]} curriculumCodes={["CR_BK_06"]}>
            <CollapsibleSubsection title="Enhanced Recovery After Surgery (ERAS): Physiology and Protocol">
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                <p><strong>Principle:</strong> ERAS is a multimodal, multidisciplinary care bundle that attenuates the surgical stress response — reducing catecholamine, cortisol, glucagon and cytokine release, insulin resistance, sodium and water retention, catabolism and ileus — so that organ function is preserved and recovery accelerated. Benefit is dose-dependent on <em>compliance</em>: each additional element implemented improves outcome, and high-compliance care reduces complications and length of stay <InlineRef topicId="gi-physiology" refLabel="ERAS Compliance 2015" />.</p>
                <p><strong>Preoperative elements:</strong> counselling and expectation setting; prehabilitation (exercise, nutrition, psychological support); smoking and alcohol cessation ~4 weeks; anaemia and iron-deficiency correction; diabetes and nutritional optimisation with oral supplements for those at risk; avoidance of mechanical bowel preparation alone (oral antibiotic ± mechanical preparation in colorectal surgery); carbohydrate loading and short fasting — clear fluids to 2 h, solids 6 h; avoidance of long-acting sedative premedication; thromboprophylaxis and single-dose antibiotic prophylaxis within 60 min of incision <InlineRef topicId="gi-physiology" refLabel="ERAS Colorectal 2018" />.</p>
                <p><strong>Intraoperative elements:</strong> short-acting anaesthetic agents with depth monitoring; opioid-sparing multimodal analgesia (paracetamol, NSAID where safe, dexamethasone, lidocaine or ketamine infusions, regional or TAP blocks, epidural for open surgery only); PONV risk-stratified multimodal prophylaxis; goal-directed, near-zero-balance fluid therapy with vasopressor support instead of fluid loading; normothermia (≥36 °C) with forced-air warming and fluid warming; lung-protective ventilation; minimally invasive surgery; and avoidance of routine nasogastric tubes and abdominal drains <InlineRef topicId="gi-physiology" refLabel="ERAS Anaesthesia Consensus 2016" />.</p>
                <p><strong>Postoperative elements:</strong> early oral intake within 24 h and oral nutritional supplements; early urinary catheter removal (24 h); structured mobilisation from day 0; opioid-sparing analgesia with regular non-opioids; chewing gum and prokinetics/laxatives for ileus prophylaxis; glycaemic control; extended thromboprophylaxis after cancer surgery; and audit with defined discharge criteria.</p>
                <p><strong>ERAS and the microbiome:</strong> the elements interact directly with gut flora — avoiding prolonged fasting and mechanical bowel preparation, limiting opioids and antibiotic duration, maintaining splanchnic perfusion by avoiding both hypovolaemia and fluid overload, and restarting enteral nutrition early all preserve microbial diversity and mucosal barrier function, providing a plausible mechanism for the reduction in infective complications and anastomotic leak.</p>
                <p><strong>Physiological rationale summary:</strong> carbohydrate loading reduces postoperative insulin resistance; epidural or regional blockade blunts afferent nociceptive stress signalling; near-zero fluid balance avoids bowel oedema and impaired anastomotic healing; normothermia reduces wound infection, coagulopathy and cardiac events; early mobilisation limits atelectasis, insulin resistance and thromboembolism.</p>
                <p><strong>Exam pitfalls:</strong> ERAS is not "early discharge"; benefit arises from compliance with the whole bundle. Epidural analgesia is <em>not</em> recommended in laparoscopic colorectal surgery. Carbohydrate loading is generally avoided in poorly controlled diabetes and delayed gastric emptying. Specialty-specific ERAS Society guidelines exist for colorectal, liver, pancreatic, gynaecological, cardiac and orthopaedic surgery.</p>
              </div>
            </CollapsibleSubsection>
          </ExamSection>
