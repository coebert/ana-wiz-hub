          ...
          <ExamSection id="tbsa-fluids" exams={[Exam.FINAL, Exam.FFICM, Exam.EDIC]}>
            ...
            <CollapsibleSubsection title="Monitoring Adequacy of Resuscitation">
              <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside leading-relaxed">
                ...
                <li><strong>Intra-abdominal pressure</strong> should be measured (via the urinary catheter, 4-hourly) in every burn above roughly <strong>20–30% TBSA</strong> and in any burn requiring large-volume resuscitation, since abdominal compartment syndrome develops insidiously even without abdominal burns. Normal IAP in the critically ill is 5–7 mmHg; intra-abdominal hypertension is a sustained IAP ≥ 12 mmHg, and abdominal compartment syndrome is IAP &gt; 20 mmHg with new organ dysfunction. Rising IAP with falling urine output, rising airway pressures and a widening base deficit is the classic pattern, and it is a signal to reduce crystalloid volume, add colloid, optimise sedation and analgesia, decompress the stomach and bladder, and consider paracentesis or decompressive laparotomy rather than to give more fluid.</li>
                <li><strong>Arterial line and CVP</strong>: an arterial line is required in any large burn for continuous MAP (target usually &gt; 65 mmHg), repeated blood gases and lactate; site it away from burned tissue where possible. CVP is unreliable as a static volume measure but its <em>trend</em>, read with cardiac output and lactate, helps identify the transition from hypovolaemia to fluid overload.</li>
                <li><strong>Microdialysis</strong> is an experimental tissue-level monitoring tool that can demonstrate ongoing dermal/muscle hypoxia and metabolic derangement despite apparently adequate systemic resuscitation end-points <InlineRef topicId="burns-icu" refLabel="Burns Microdialysis 2007" />. Urinary biomarkers such as the albumin:creatinine ratio predict mortality in extensive burns but do not track day-to-day clinical change, so they do not replace urine output, creatinine and clinical assessment <InlineRef topicId="burns-icu" refLabel="BJA Burns Albuminuria 2006" />.</li>
              </ul>
            </CollapsibleSubsection>
          </ExamSection>
