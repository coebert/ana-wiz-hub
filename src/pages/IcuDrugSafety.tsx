  ...
  return (
    <main className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Pharmacokinetics, half-life, clearance, interactions, contraindications and monitoring for 50 adult intensive care drugs — sedatives, neuromuscular blockers."
        />
      ...
      <PageSection className="pt-8 pb-16">
        ...
        <p className="mt-10 text-sm text-muted-foreground">
          ...
          , the{" "}
          <Link to="/intensive-care/interaction-matrix" className="font-medium text-icu underline-offset-4 hover:underline">
            interaction matrix
          </Link>{" "}
          and the{" "}
