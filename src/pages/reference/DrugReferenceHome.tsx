...
export default function DrugReferenceHome() {
    ...
    >
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form
          ...
          onSubmit={(e) => {
            e.preventDefault();
            if (suggestions.length > 0) navigate(`/reference/drugs/${suggestions[0].slug}`);
            else navigate(`/reference/drugs?q=${encodeURIComponent(query)}`);
          }}
        >
