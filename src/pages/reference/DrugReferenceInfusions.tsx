...
export default function DrugReferenceInfusions() {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-sm">
                      <Link
                        to={`/reference/calculator?drug=${encodeURIComponent(d.drug)}&weight=${safeWeight}`}
                        className="text-primary underline"
                      >
                        Calculate a rate
                      </Link>
                      {d.slug && (
                        <Link to={`/reference/drugs/${d.slug}`} className="text-primary underline">
                          Full monograph
                        </Link>
                      )}
                    </p>
