...
const caseSeeds: CaseSeed[] = [
  ...
  {
    id: "paed-fontan-appendicectomy", title: "Fontan circulation for laparoscopic appendicectomy", category: "Paediatric anaesthesia", difficulty: "Advanced",
    patient: "A 9-year-old girl with hypoplastic right heart and a total cavopulmonary connection (Fontan) at age 4 presents with appendicitis. Saturations are 92% in air and she takes aspirin.",
    presentation: "She has been vomiting for 12 hours and fasted overnight without IV fluid. The surgeon plans laparoscopy with a pneumoperitoneum of 14 mmHg.",
    stages: [
      { title: "Explain the circulation", prompt: "What determines her cardiac output?", answer: ["There is no subpulmonary ventricle: pulmonary flow is passive and depends on the transpulmonary gradient, so it needs adequate central venous pressure (usually 10–15 mmHg) and low pulmonary vascular resistance.", "Hypoxia, hypercarbia, acidosis, pain and high mean airway pressure all raise pulmonary vascular resistance and cut output.", "Loss of sinus rhythm, hypovolaemia and single-ventricle diastolic dysfunction are poorly tolerated."] },
      { title: "Optimise before theatre", prompt: "What do you do preoperatively?", answer: ["Stop the fasting deficit worsening: give maintenance IV fluid and correct hypovolaemia, following APAGBI 6–4–2 fasting rather than prolonged starvation.", "Review the most recent echocardiogram, saturations, anticoagulation and any protein-losing enteropathy or arrhythmia history with paediatric cardiology.", "Book a paediatric cardiac critical-care bed and senior anaesthetic help; this is not a routine list case."] },
      { title: "Deliver the anaesthetic", prompt: "How will you ventilate and monitor her?", answer: ["Negotiate low-pressure pneumoperitoneum (8–10 mmHg) and minimal head-up tilt; laparoscopy plus IPPV is a double insult to passive pulmonary flow.", "Use gentle IPPV with low mean airway pressure, short inspiratory time and modest PEEP, maintaining normocarbia, generous inspired oxygen and normal pH.", "Use invasive arterial monitoring, titrated induction with adequate preload, meticulous air-bubble exclusion from lines, and continue thromboprophylaxis postoperatively."] },
    ], takeHome: "In a Fontan, output depends on preload and low pulmonary vascular resistance: avoid dehydration, hypercarbia, acidosis, pain and high airway or insufflation pressures, and plan with cardiology and critical care.", sourceLinks: [sources.achd, sources.apagbi],
  },
  {
    id: "paed-neonatal-resuscitation", title: "Neonatal resuscitation at emergency caesarean birth", category: "Paediatric anaesthesia", difficulty: "Foundation",
    patient: "You are the anaesthetist at a category 1 caesarean birth at 39 weeks for a prolonged fetal bradycardia. The baby is delivered apnoeic and floppy.",
    presentation: "At 60 seconds the heart rate is 50/min, there is no respiratory effort and the baby is pale and wet on an open resuscitaire.",
    stages: [
      { title: "Start the airway and thermal care", prompt: "What are your first actions?", answer: ["Dry, remove wet towels, cover with a hat and warm towel under a radiant warmer, and keep temperature 36.5–37.5 °C.", "Open the airway in the neutral position and give five inflation breaths at 30 cmH₂O over 2–3 seconds in air for a term baby (25 cmH₂O if preterm).", "Reassess chest movement and heart rate: transition failure is a respiratory problem, so aeration comes before compressions."] },
      { title: "Escalate when the heart rate stays low", prompt: "The heart rate is still 40/min after effective inflations. What next?", answer: ["Start chest compressions at a 3:1 compression-to-ventilation ratio (about 120 events per minute), intubate and increase inspired oxygen towards 100%.", "Gain umbilical venous or intraosseous access and give adrenaline 10–30 micrograms/kg IV (0.1–0.3 mL/kg of 1:10 000), repeated every 3–5 minutes.", "Give glucose 250 mg/kg (2.5 mL/kg of 10%) for hypoglycaemia and 10 mL/kg 0.9% saline or blood if hypovolaemia is suspected."] },
      { title: "Consider the reversible causes", prompt: "What specific diagnoses would change your management?", answer: ["Pneumothorax, congenital diaphragmatic hernia (avoid bag-mask ventilation, pass a gastric tube and intubate), airway obstruction and blood loss.", "Target preductal saturations of roughly 60% at 2 minutes, 70% at 3, 80% at 5 and 85% at 10 minutes rather than immediate normoxia.", "Arrange neonatal review, avoid hyperthermia and refer for therapeutic hypothermia if there is moderate or severe encephalopathy."] },
    ], takeHome: "Newborn resuscitation is airway and lung aeration first — five inflation breaths, then 3:1 compressions if the heart rate stays below 60/min, with adrenaline 10–30 micrograms/kg and strict thermal care.", sourceLinks: [sources.nls, sources.pals],
  },
  {
    id: "paed-ex-premature-hernia", title: "Ex-premature infant for inguinal hernia repair", category: "Paediatric anaesthesia", difficulty: "Intermediate",
    patient: "An infant born at 28 weeks is now 8 weeks old (36 weeks post-conceptual age) and listed for repair of a reducible inguinal hernia. Haemoglobin is 92 g/L.",
    presentation: "The list is a day-case list and the parents have been told the baby will go home the same afternoon. There is a history of neonatal apnoeas.",
    stages: [
      { title: "Assess the apnoea risk", prompt: "What drives postoperative apnoea risk here?", answer: ["Immature central respiratory control: risk is high below about 46 weeks post-conceptual age and remains appreciable to 60 weeks.", "Anaemia below 100 g/L and a previous apnoea history independently increase risk.", "Day-case surgery is inappropriate — this baby needs admission and monitoring."] },
      { title: "Choose the technique", prompt: "How will you anaesthetise the baby?", answer: ["Awake spinal or caudal anaesthesia without any sedative supplement reduces early postoperative apnoea compared with general anaesthesia.", "If general anaesthesia is used, keep it opioid-sparing with a regional block, and remember the GAS trial found no neurodevelopmental difference between awake-regional and sevoflurane anaesthesia.", "Give caffeine citrate 10 mg/kg IV at induction and maintain normothermia and normoglycaemia."] },
      { title: "Plan recovery", prompt: "What postoperative care do you arrange?", answer: ["Admit for at least 12 apnoea-free hours with continuous apnoea, saturation and heart-rate monitoring, extended if events occur.", "Nurse where escalation is possible, with staff briefed on apnoea management: stimulation, oxygen and ventilatory support.", "Treat anaemia, and review for sepsis, hypoglycaemia and intracranial pathology if apnoea persists."] },
    ], takeHome: "Ex-premature infants need post-conceptual age and haemoglobin calculated, sedation-free regional anaesthesia where possible, caffeine at induction and admission with apnoea monitoring — never day-case discharge.", sourceLinks: [sources.apagbi, sources.bnfc],
  },
  {
    id: "paed-pyloric-stenosis", title: "Pyloric stenosis with metabolic alkalosis", category: "Paediatric anaesthesia", difficulty: "Intermediate",
    patient: "A 5-week-old boy has three days of projectile non-bilious vomiting and a palpable pyloric mass. Weight 3.9 kg.",
    presentation: "Chloride is 88 mmol/L, potassium 3.0 mmol/L, sodium 130 mmol/L, bicarbonate 34 mmol/L and pH 7.52. The surgeon wants to operate within the hour.",
    stages: [
      { title: "Interpret the biochemistry", prompt: "Explain the picture and its implications.", answer: ["Loss of gastric hydrogen and chloride causes hypochloraemic hypokalaemic metabolic alkalosis, with paradoxical aciduria once volume depletion drives renal sodium–hydrogen exchange.", "Alkalosis depresses respiratory drive and predisposes to postoperative apnoea; hypokalaemia risks arrhythmia.", "Chloride is the most useful marker of adequate resuscitation."] },
      { title: "Resuscitate before theatre", prompt: "What do you correct, and to what targets?", answer: ["This is a medical, not a surgical, emergency: delay surgery until chloride is above 100–106 mmol/L, bicarbonate below 26–30 mmol/L, sodium above 132 mmol/L and potassium normal with good urine output.", "Give 10–20 mL/kg 0.9% saline boluses for hypovolaemia, then 0.9% saline with 5% glucose plus potassium (typically 10–20 mmol/500 mL) at around 150% maintenance.", "Pass a nasogastric tube on free drainage and monitor glucose — glycogen stores are small."] },
      { title: "Anaesthetise and recover safely", prompt: "Describe your anaesthetic plan.", answer: ["Treat as a full stomach: aspirate the nasogastric tube in supine, left and right lateral positions, then rapid sequence or modified induction with a cuffed tube, atropine 20 micrograms/kg available and rocuronium or suxamethonium 2 mg/kg.", "Provide paracetamol with wound infiltration or a rectus sheath block and avoid opioid where possible.", "Observe with apnoea and saturation monitoring for 12–24 hours, checking glucose and re-establishing feeds per surgical protocol."] },
    ], takeHome: "Never take an unresuscitated baby with pyloric stenosis to theatre: correct chloride, potassium and alkalosis first, empty the stomach, avoid opioids and monitor for postoperative apnoea and hypoglycaemia.", sourceLinks: [sources.apagbi, sources.bnfc],
  },
  {
    id: "paed-tet-spell", title: "Hypercyanotic spell in unrepaired tetralogy of Fallot", category: "Paediatric anaesthesia", difficulty: "Advanced",
    patient: "An 11-month-old girl awaiting repair of tetralogy of Fallot is anaesthetised for a CT scan. Baseline saturations are 85%.",
    presentation: "After inhalational induction with sevoflurane she becomes deeply cyanosed with saturations of 55%, and the previously loud systolic murmur disappears.",
    stages: [
      { title: "Recognise the physiology", prompt: "What is happening?", answer: ["A hypercyanotic ('tet') spell: dynamic right ventricular outflow tract obstruction plus falling systemic vascular resistance increases right-to-left shunt across the ventricular septal defect.", "The murmur softens because flow across the outflow tract has fallen — a sign of worsening, not improvement.", "Sevoflurane-induced vasodilation, hypovolaemia, tachycardia and catecholamines all aggravate it."] },
      { title: "Treat immediately", prompt: "What are your interventions?", answer: ["100% oxygen, knee-to-chest positioning or aortic/femoral compression, and a 10–20 mL/kg fluid bolus.", "Raise systemic vascular resistance with phenylephrine 1–5 micrograms/kg IV or metaraminol; deepen anaesthesia with ketamine 1–2 mg/kg, which preserves systemic vascular resistance.", "Slow outflow-tract spasm with esmolol 0.5 mg/kg or propranolol 0.01–0.1 mg/kg, correct acidosis with bicarbonate and consider morphine to abolish hyperpnoea."] },
      { title: "Avoid the wrong drugs and escalate", prompt: "What must you not do, and what next?", answer: ["Avoid adrenaline, dobutamine and milrinone: inotropy and vasodilation both increase the dynamic obstruction and shunt.", "Exclude air bubbles from every line because paradoxical embolism is possible.", "Call paediatric cardiology and cardiac anaesthesia early; refractory spells need ECMO or urgent surgical palliation, and the child needs cardiac critical care afterwards."] },
    ], takeHome: "Treat a tet spell by raising systemic vascular resistance and preload and slowing the outflow-tract spasm — oxygen, knees to chest, fluid, phenylephrine, ketamine and a beta blocker — and never with inotropes.", sourceLinks: [sources.achd, sources.apagbi],
  },
  {
    id: "paed-inhaled-foreign-body", title: "Inhaled foreign body in a toddler", category: "Paediatric anaesthesia", difficulty: "Advanced",
    patient: "A 2-year-old boy choked on a peanut two hours ago. He is distressed with intermittent cough, unilateral wheeze and reduced right-sided air entry. Weight 13 kg.",
    presentation: "Saturations are 93% in air, the chest radiograph is reported as normal, and rigid bronchoscopy is planned in a shared airway with the ENT surgeon.",
    stages: [
      { title: "Prepare and plan", prompt: "What must be agreed before induction?", answer: ["A normal radiograph does not exclude a foreign body: the history plus unilateral signs is enough to proceed.", "Agree with the surgeon and theatre team the ventilation strategy, bronchoscope and tube sizes, oxygenation route and the rescue plan for complete obstruction.", "Keep the child calm with a parent present and do not instrument the airway until anaesthetised."] },
      { title: "Induce and maintain", prompt: "How will you anaesthetise him?", answer: ["Use inhalational induction in oxygen with sevoflurane and maintain spontaneous ventilation where obstruction is significant; positive pressure can push a mobile object distally or cause ball-valve gas trapping.", "Topicalise the larynx with lidocaine, counting all routes towards a maximum of 3 mg/kg, and use an antisialagogue if secretions obscure the view.", "Oxygenate via the bronchoscope side arm, and give dexamethasone 0.1–0.15 mg/kg for airway oedema."] },
      { title: "Anticipate complications", prompt: "What can go wrong, and how do you recover him?", answer: ["Complete obstruction, gas trapping with tension physiology, laryngospasm, desaturation, bleeding and retained fragments.", "Have suction, forceps, size-appropriate tubes and a plan for tracheostomy or ECMO immediately available.", "Recover in a high-observation area watching for stridor from airway oedema and post-obstructive pulmonary oedema; do not discharge the same day."] },
    ], takeHome: "In a shared, partially obstructed paediatric airway, keep the child calm, induce inhalationally with spontaneous ventilation, agree the plan with the surgeon, and watch for gas trapping and postoperative airway oedema.", sourceLinks: [sources.apagbi, sources.pals],
  },
];
