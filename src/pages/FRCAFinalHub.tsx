...
const FRCAFinalHub = () => (
  <ExamHub
    ...
    metaDescription="Free FRCA Final revision: every Final FRCA syllabus topic across clinical anaesthesia, intensive care and perioperative medicine with exam-shaped notes, diagrams and questions."
