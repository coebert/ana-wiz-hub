...
export const perioperativeCaseIndex: PerioperativeCaseIndexEntry[] = [
  ...
  { id: "paed-pyloric-stenosis", title: "Pyloric stenosis with metabolic alkalosis", category: "Paediatric anaesthesia", difficulty: "Intermediate", summary: "Hypochloraemic hypokalaemic alkalosis, resuscitation targets and full-stomach induction.", topicIds: ["paediatric-anaesthesia", "acid-base", "fluid-therapy", "emergency-surgery"] },
  { id: "paed-tet-spell", title: "Hypercyanotic spell in unrepaired tetralogy of Fallot", category: "Paediatric anaesthesia", difficulty: "Advanced", summary: "Right-to-left shunt physiology, vasoconstrictors and beta blockade in a tet spell.", topicIds: ["paediatric-anaesthesia", "paediatric-icu", "cardiovascular-physiology", "cardiovascular-disease"] },
