...
export const seeAlsoMap: Record<string, string[]> = {
  // ── Physics ──
  "gas-laws": ["equipment-monitoring", "si-units-thermodynamics", "humidity-gas-sampling"],
  "pressure-measurement": ["clinical-measurement", "flow-measurement", "equipment-monitoring"],
  "flow-measurement": ["pressure-measurement", "equipment-monitoring", "gas-laws"],
  ...
  "xray-radiation-safety": ["mri-physics", "ultrasound-physics", "interventional-radiology", "electrical-safety"],
  ...
  "equipment-monitoring": ["clinical-measurement", "pressure-measurement", "flow-measurement", "gas-laws", "humidity-gas-sampling"],
  ...
  "muscle-relaxants": ["rocuronium", "neuromuscular", "neurological-disease", "pharmacodynamics"],
  "rocuronium": ["muscle-relaxants", "airway-management", "neuromuscular", "pharmacokinetics"],
  ...
  "cardiothoracic": ["cardiac-anatomy", "thoracic-anatomy", "cardiac-cycle", "cardiovascular-disease", "circulatory-failure"],
  "trauma-emergency": ["emergency-surgery", "transfusion-coagulation", "airway-management", "transfer-medicine", "mass-casualty-military"],
  "clinical-incidents": ["airway-management", "local-anaesthetics", "toxicology", "mass-casualty-military"],
  ...
  "burns-plastics": ["plastic-surgery", "perioperative-fluids", "pain-medicine", "airway-management", "burns-icu"],
  "burns-icu": ["burns-plastics", "ards", "mechanical-ventilation", "sepsis-shock", "transfusion-coagulation", "trauma-emergency", "mass-casualty-military"],
  ...
  "circulatory-failure": ["vasoactive-agents", "cardiac-output-monitoring", "starling-forces", "sepsis", "cardiovascular-disease", "pulmonary-hypertension", "ards", "cardiothoracic", "mechanical-ventilation"],
  ...
  "organ-donation": ["neurointensive-care", "acute-liver-failure", "prognostication-ethics-icu"],
  "antimicrobials-icu": ["antimicrobials-pharm", "sepsis", "infectious-disease-icu"],
  "prognostication-ethics-icu": ["organ-donation", "neurointensive-care", "icu-sedation-delirium", "sepsis", "elderly-anaesthesia", "end-of-life-communication"],
  "end-of-life-communication": ["prognostication-ethics-icu", "organ-donation", "non-technical-skills", "icu-sedation-delirium", "neurointensive-care"],
  "non-technical-skills": ["end-of-life-communication", "clinical-incidents", "transfer-medicine", "prognostication-ethics-icu"],
  "infectious-disease-icu": ["sepsis", "antimicrobials-icu", "neurointensive-care", "aki-rrt", "haematology-icu"],
  "paediatric-icu": ["paediatric-emergencies", "paediatric-anaesthesia", "foetal-circulation", "sepsis"],
  "paediatric-emergencies": ["paediatric-icu", "paediatric-anaesthesia", "foetal-circulation", "sepsis", "paediatric-core"],
  "haematology-icu": ["haematology-immunity", "transfusion-coagulation", "anticoagulants"],
  "pulmonary-hypertension": ["cardiovascular-disease", "circulatory-failure", "ards", "cardiac-output-monitoring", "cardiac-cycle"],
