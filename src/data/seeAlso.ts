...
export const seeAlsoMap: Record<string, string[]> = {
  ...
  "transfer-medicine": ["trauma-emergency", "clinical-incidents", "equipment-monitoring", "resource-poor-anaesthesia"],
  "resource-poor-anaesthesia": ["obstetric-anaesthesia", "regional-anaesthesia", "iv-anaesthetics", "volatile-agents", "trauma-emergency", "transfer-medicine"],
