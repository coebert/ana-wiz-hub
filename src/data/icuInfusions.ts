...
export const icuInfusionGroups: InfusionGroup[] = [
  {
    ...
    infusions: [
      ...
      },
      {
        ...
        maxDose: 1000,
        perKg: false,
        notes: "Predominantly α₁ agonist with indirect action. Often run peripherally short-term; handy bridge while central access is established. Also given as 0.5–1 mg boluses.",
  ...
  },
  {
    ...
    infusions: [
      ...
      },
      {
        ...
        maxDose: 3,
        perKg: true,
        notes: "Adjunct for analgosedation, especially with opioid tolerance or severe bronchospasm. Psychotomimetic effects less prominent at infusion rates.",
        topicIds: ["icu-sedation-delirium", "intravenous-anaesthetics"],
      },
    ],
  },
