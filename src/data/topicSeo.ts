...
export const topicSeo: Record<string, TopicSeo> = {
  ...
  "paediatric-icu": {
    title: "Paediatric Intensive Care & Emergencies: PICU | FFICM",
    description: "Paediatric intensive care and emergencies for FFICM: collapsing neonate, sepsis by age, metabolic crises and ammonia scavengers, arrest algorithms, stroke, PICU organ support.",
