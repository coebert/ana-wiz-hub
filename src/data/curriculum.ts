...
export const physicsTopics: Topic[] = [
  ...
  { id: "breathing-circuits", title: "Anaesthetic Breathing Systems", description: "Mapleson A–F classification, A↔D spontaneous vs IPPV reversal, Bain coaxial, circle system components, low-flow anaesthesia, soda lime chemistry, Compound A and CO", section: "physics", examTags: ["primary", "final", "fficm"], available: true },
  { id: "ventilator-modes", title: "Ventilator Modes", description: "AC/CMV (PC and VC), SIMV, PSV/CPAP and PRVC — trigger / limit / cycle, waveform fingerprints, dyssynchrony patterns and mode selection for ARDS and weaning", section: "physics", examTags: ["final", "fficm"], available: true },
  { id: "capnography", title: "Capnography", description: "Infrared CO₂ physics, sidestream vs mainstream sampling, four phases of the normal waveform, abnormal patterns (shark-fin, curare cleft, raised baseline, disconnection, cardiac oscillations) and capnography in CPR", section: "physics", examTags: ["primary", "final", "fficm"], available: true },
  // Patient monitoring
...
export const perioperativeTopics: Topic[] = [
  ...
  { id: "haematological-disease", title: "Haematological Co-Existing Disease", description: "Perioperative anaemia (incl. iron deficiency), thrombocytopenia and neutropenia — patient blood management, transfusion thresholds and procedural safety", section: "perioperative", examTags: ["primary", "final", "fficm"], available: true },
  ...
  { id: "renal-disease", title: "Renal Co-Existing Disease", description: "CKD staging, dialysis-dependent patients, altered pharmacology, electrolyte emergencies, transplant recipients, perioperative AKI prevention", section: "perioperative", examTags: ["primary", "final", "fficm"], available: true },
  { id: "musculoskeletal-disease", title: "Musculoskeletal & Rheumatological Disease", description: "Rheumatoid arthritis, ankylosing spondylitis, connective tissue disease, cervical spine instability, DMARDs and biologics", section: "perioperative", examTags: ["final", "fficm"], available: true },
  { id: "gastrointestinal-disease", title: "Gastrointestinal Co-Existing Disease", description: "GORD and aspiration risk, inflammatory bowel disease, malnutrition, intestinal failure, bowel obstruction and stoma physiology", section: "perioperative", examTags: ["final", "fficm"], available: true },
  { id: "psychiatric-substance-disease", title: "Psychiatric Disease & Substance Misuse", description: "Antidepressants, antipsychotics, lithium, ECT, serotonin syndrome, alcohol, opioid and stimulant use disorders, capacity and withdrawal", section: "perioperative", examTags: ["final", "fficm"], available: true },
  { id: "complex-needs-anaesthesia", title: "Anaesthesia for Patients with Complex Needs", description: "Learning disability, autism, severe phobia, behaviour that challenges, capacity and restraint, plus anaesthesia for patients in prison custody", section: "perioperative", examTags: ["final", "fficm"], available: true },
  { id: "immunosuppression-hiv", title: "Immunosuppression & HIV", description: "Transplant immunosuppressants, biologics, corticosteroids, HIV and antiretroviral interactions, asplenia, infection risk and precautions", section: "perioperative", examTags: ["final", "fficm"], available: true },
