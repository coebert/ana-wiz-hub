...
export const ACCENT_BANK: PodcastAccent[] = [
  ...
  },
  {
    ...
    label: "Shropshire / Welsh Marches",
  ...
  {
    id: "british-bolton",
    label: "Bolton / Greater Manchester towns",
  ...
  {
    id: "british-preston",
    label: "Preston / Central Lancashire",
