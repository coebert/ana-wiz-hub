    ...
    <div className="space-y-2">
      <svg viewBox="0 0 500 280" className="w-full" role="img" aria-label="Absorption spectra of oxyhaemoglobin and deoxyhaemoglobin">
        ...
        {(() => {
          ...
          return (
            <>
              <line x1={x} y1="40" x2={x} y2="225" stroke="red" strokeWidth="1.5" strokeDasharray="4 3" opacity="0.6" />
              <rect x={x - 20} y="35" width="40" height="18" rx="3" fill="red" opacity="0.15" />
              <text x={x} y="48" fill="red" fontSize="9" textAnchor="middle" fontWeight="bold">660nm</text>
            </>
          );
        })()}
        ...
        {(() => {
          ...
          return (
            <>
              ...
              <rect x={x - 20} y="35" width="40" height="18" rx="3" fill="hsl(var(--primary))" opacity="0.15" />
        ...
        {/* Legend */}
        <line x1="320" y1="265" x2="340" y2="265" stroke="hsl(var(--destructive))" strokeWidth="2.5" />
        <text x="345" y="269" fill="hsl(var(--foreground))" fontSize="10">DeoxyHb</text>
        <line x1="400" y1="265" x2="420" y2="265" stroke="hsl(var(--primary))" strokeWidth="2.5" />
