  ...
  return (
    ...
    >
        ...
        <div className="bg-secondary/30 rounded-lg p-4 border border-border text-xs space-y-1.5">
          ...
          <p className="text-foreground"><strong>Line Isolation Monitor (LIM):</strong> continuously measures the impedance between each conductor and earth. If a single fault (e.g., a wet cable, equipment insulation failure) falls low enough that a prospective fault current of about 2–5 mA could flow were a second fault to occur, the LIM alarms. The supply is <em>not</em> automatically cut: in theatre, abrupt loss of power (e.g., to a CPB pump or ventilator) can be more dangerous than the fault itself.</p>
