...
export const LungVolumesDiagram = () => {
  ...
  return (
    <DiagramFigure
      ...
      title="Lung volumes"
      description="Lung volumes: labelled teaching figure showing the structures, relationships and key values FRCA and FFICM candidates need to recognise and explain for this topic."
    >
