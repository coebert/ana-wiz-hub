...
const PulmonaryFibrosisDiagram = () => {
  return (
    <DiagramFigure
      id="pulmonary-fibrosis-diagram"
      title="Pulmonary fibrosis"
      description="Auto-generated wrapper for the Pulmonary fibrosis anatomical/physiological diagram. Review and replace with a specific, curriculum-aligned summary of what learners should take from the figure."
    >
