...
const STANDARD_LEADS: LeadDef[] = [
  ...
  { id: "II",  col: 0, row: 1, primary: "inferior", reciprocalOf: ["lateral"] },
  ...
  { id: "III", col: 0, row: 2, primary: "inferior", reciprocalOf: ["lateral"] },
  { id: "aVF", col: 1, row: 2, primary: "inferior", reciprocalOf: ["lateral"] },
