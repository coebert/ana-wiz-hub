...
import { PlexusChipRow, PlexusDetailPanel, ROOT_COLORS } from "@/components/diagrams/shared/plexusShared";
...
const LumbosacralPlexusDiagram = () => {
  ...
  return (
    <DiagramFigure
      ...
      description="Lumbosacral plexus: labelled teaching figure showing the structures, relationships and key values FRCA and FFICM candidates need to recognise and explain for this topic."
    >
