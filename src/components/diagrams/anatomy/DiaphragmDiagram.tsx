...
export const DiaphragmDiagram = () => {
  ...
  return (
    <DiagramFigure
      id="diaphragm-diagram"
      title="Diaphragm"
      description="Auto-generated wrapper for the Diaphragm anatomical/physiological diagram. Review and replace with a specific, curriculum-aligned summary of what learners should take from the figure."
    >
