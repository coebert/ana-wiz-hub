    ...
    return (
      <div className="w-full max-w-lg mx-auto space-y-3">
        ...
        <svg viewBox={`0 0 ${svgW} ${svgH}`} className="w-full">
          ...
          <text x={svgW / 2} y={svgH - 2} textAnchor="middle" fontSize="8" fill="hsl(var(--muted-foreground))" opacity="0.5">PaO₂ (mmHg)</text>
          <text x={svgW / 2} y={svgH - padB + 14} textAnchor="middle" fontSize="10" fill="hsl(var(--muted-foreground))" fontWeight="600">PaO₂ (kPa)</text>
          ...
          {viewMode === "saturation" && (
            <>
              <line x1={toX(26.7 / 7.5)} y1={toY(50)} x2={toX(26.7 / 7.5)} y2={toY(0)} stroke="hsl(170 50% 40%)" strokeWidth="0.8" strokeDasharray="3 3" opacity="0.5" />
              <line x1={toX(0)} y1={toY(50)} x2={toX(26.7 / 7.5)} y2={toY(50)} stroke="hsl(170 50% 40%)" strokeWidth="0.8" strokeDasharray="3 3" opacity="0.5" />
