        ...
        <svg viewBox="0 0 520 420" className="w-full max-w-[520px] mx-auto" style={{ minWidth: 320 }}>
          <defs>
            ...
            <pattern id="driving-gas" width="8" height="8" patternUnits="userSpaceOnUse">
              <circle cx="4" cy="4" r="1" fill="#F59E0B" opacity="0.4" />
            </pattern>
          </defs>
          ...
          <rect x="140" y="60" width="180" height="230" rx="8" ry="8"
            fill="none" stroke="hsl(var(--foreground))" strokeWidth="2.5" opacity="0.7" />
          {/* Label */}
          ...
          <g>
            ...
            {[0.2, 0.4, 0.6, 0.8].map((f) => (
              <line key={f}
                ...
                stroke={isInsp ? "#3B82F6" : "#10B981"} strokeWidth="0.8" opacity="0.5"
                style={{ transition: "all 0.8s ease-in-out" }}
              />
            ))}
          ...
          <line x1="400" y1="120" x2="400" y2="132" stroke="hsl(var(--foreground))" strokeWidth="1.2" opacity="0.4" />
          <line x1="393" y1="125" x2="407" y2="125" stroke="hsl(var(--foreground))" strokeWidth="1.2" opacity="0.4" />
          ...
          <line x1="60" y1="180" x2="140" y2="180" stroke="#F59E0B" strokeWidth="2.5" strokeDasharray={drivingGasActive ? "none" : "4,4"} />
          <text x="55" y="172" textAnchor="end" fontSize="9" fill="#F59E0B" fontFamily="Inter, sans-serif" fontWeight="600">Driving</text>
          <text x="55" y="183" textAnchor="end" fontSize="9" fill="#F59E0B" fontFamily="Inter, sans-serif" fontWeight="600">Gas</text>

          {/* Driving gas flow arrow during inspiration */}
          {drivingGasActive && (
            <line x1="70" y1="190" x2="130" y2="190"
              stroke="#F59E0B" strokeWidth="1.5" markerEnd="url(#bib-arrow-orange)">
          ...
          <line x1="60" y1="270" x2="175" y2="270" stroke="#10B981" strokeWidth="2" />
          <line x1="175" y1="270" x2="175" y2={bellowsTop + bellowsH}
            stroke="#10B981" strokeWidth="1.5" strokeDasharray="3,3"
            style={{ transition: "all 0.8s ease-in-out" }} />
          <text x="55" y="264" textAnchor="end" fontSize="9" fill="#10B981" fontFamily="Inter, sans-serif" fontWeight="600">Fresh Gas</text>
          <text x="55" y="275" textAnchor="end" fontSize="9" fill="#10B981" fontFamily="Inter, sans-serif" fontWeight="600">Flow (FGF)</text>

          {/* ===== EXPIRATORY VALVE / APL ===== */}
          <line x1="400" y1="100" x2="460" y2="100" stroke="hsl(var(--foreground))" strokeWidth="1.5" opacity="0.5" />
          <rect x="460" y="88" width="40" height="24" rx="4" fill={!isInsp ? "#EF444430" : "#EF444410"} stroke="#EF4444" strokeWidth="1.5" />
          <text x="480" y="103" textAnchor="middle" fontSize="7" fill="#EF4444" fontFamily="Inter, sans-serif" fontWeight="600">APL</text>
          ...
          {isInsp ? (
            <>
              ...
              <line x1="240" y1={bellowsTop - 5} x2="240" y2="55"
                stroke="#3B82F6" strokeWidth="2" markerEnd="url(#bib-arrow-blue)"
                style={{ transition: "all 0.8s ease-in-out" }}>
              </line>
            ...
            <>
              ...
              <line x1="404" y1="95" x2="404" y2="55"
                stroke="#10B981" strokeWidth="2" markerEnd="url(#bib-arrow-green)" />
              ...
              <line x1="465" y1="105" x2="465" y2="135"
                stroke="#EF4444" strokeWidth="1.5" markerEnd="url(#bib-arrow-red)" />
              <text x="465" y="148" textAnchor="middle" fontSize="8" fill="#EF4444" fontFamily="Inter, sans-serif">Exhaust</text>

              {/* Driving gas exits during expiration */}
              <line x1="130" y1="195" x2="80" y2="195"
                stroke="#F59E0B" strokeWidth="1.5" markerEnd="url(#bib-arrow-orange)" opacity="0.5">
              </line>
            </>
          )}

          {/* ===== EXPLANATION BOX ===== */}
          <rect x="20" y="310" width="480" height="100" rx="8" fill="hsl(var(--secondary))" opacity="0.3" />
          <rect x="20" y="310" width="480" height="100" rx="8" fill="none" stroke="hsl(var(--border))" strokeWidth="1" />

          {isInsp ? (
            <>
              <text x="260" y="332" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#3B82F6" fontFamily="Inter, sans-serif">
                INSPIRATION
              </text>
              ...
              <text x="260" y="395" textAnchor="middle" fontSize="9" fill="#F59E0B" fontFamily="Inter, sans-serif">
                Driving gas (orange) fills the space around the bellows.
              </text>
            </>
          ) : (
            <>
              <text x="260" y="332" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#10B981" fontFamily="Inter, sans-serif">
                EXPIRATION
              </text>
              <text x="260" y="350" textAnchor="middle" fontSize="9.5" fill="hsl(var(--foreground))" fontFamily="Inter, sans-serif">
              ...
              <text x="260" y="380" textAnchor="middle" fontSize="9" fill="#EF4444" fontFamily="Inter, sans-serif">
          ...
          <g transform="translate(20, 55)">
            ...
            <circle cx="12" cy="46" r="4" fill="#F59E0B" />
