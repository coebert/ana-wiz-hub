  ...
  return (
    <div className="w-full">
      <svg viewBox="0 0 400 320" className="w-full h-auto" role="img"
        ...
        <g transform="translate(50, 62)" opacity={active >= 1 ? 1 : 0.4} className="transition-opacity duration-500">
        ...
        <g transform="translate(140, 158)" opacity={active >= 2 ? 1 : 0.4} className="transition-opacity duration-500">
        ...
        <g transform="translate(15, 222)" opacity={active >= 2 ? 1 : 0.35} className="transition-opacity duration-500">
        ...
        <g transform="translate(255, 222)" opacity={active >= 3 ? 1 : 0.35} className="transition-opacity duration-500">
          <rect width="130" height="44" rx="6"
        ...
        <g transform="translate(50, 282)" opacity={active >= 4 ? 1 : 0.35} className="transition-opacity duration-500">
        ...
        <g transform="translate(210, 282)" opacity={active >= 4 ? 1 : 0.35} className="transition-opacity duration-500">
          <rect width="140" height="32" rx="6"
