...
const AnimatedArm = ({
  ...
  return (
    <DiagramFigure
      ...
      description="Patient positioning diagrams: labelled teaching figure summarising the key structures, relationships and values FRCA and FFICM candidates need to recognise and explain."
    >
