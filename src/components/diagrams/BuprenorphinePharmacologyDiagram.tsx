...
export const BuprenorphinePharmacologyDiagram = () => {
  ...
  return (
    <DiagramFigure
      id="buprenorphine-pharmacology-diagram"
      title="Buprenorphine pharmacology"
      description="Auto-generated wrapper for the Buprenorphine pharmacology anatomical/physiological diagram. Review and replace with a specific, curriculum-aligned summary of what learners should take from the figure."
    >
