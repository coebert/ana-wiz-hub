...
const SepsisManagementDiagram = () => {
  ...
  return (
    <DiagramFigure
      ...
      description="Sepsis management: labelled teaching figure showing the structures, relationships and key values FRCA and FFICM candidates need to recognise and explain for this topic."
    >
            ...
            <div className="bg-background rounded-lg border border-border p-3 mb-3">
              <svg viewBox="0 0 420 180" className="w-full h-auto">
                ...
                {vasopressors.slice(0, 4).map((v, i) => {
                  ...
                  return (
                        <g key={v.id} {...svgNodeProps(`Step ${i + 1}/4 — ${v.line}: ${v.name} (${v.dose})`)}>
