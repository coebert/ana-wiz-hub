...
const CardiacConductionDiagram = () => {
  ...
  return (
    <DiagramFigure
      ...
      description="Anterior view of the cardiac conduction system: SA node → internodal tracts (+ Bachmann) → AV node → bundle of His → R/L bundle branches (+ L anterior/posterior fascicles) → Purkinje fibres."
    >
