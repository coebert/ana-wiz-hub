...
const EchoDiagram = () => {
  ...
  return (
    <DiagramFigure
      id="echo-diagram"
      title="Echo"
      description="Echo: labelled teaching figure showing the structures, relationships and key values FRCA and FFICM candidates need to recognise and explain for this topic."
    >
