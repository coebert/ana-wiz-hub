...
export const NaloxoneDiagram = () => {
  ...
  return (
    <DiagramFigure
      id="naloxone-diagram"
      title="Naloxone"
      description="Auto-generated wrapper for the Naloxone anatomical/physiological diagram. Review and replace with a specific, curriculum-aligned summary of what learners should take from the figure."
    >
