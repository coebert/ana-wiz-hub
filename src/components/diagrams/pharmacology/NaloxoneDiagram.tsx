...
export const NaloxoneDiagram = () => {
  ...
  return (
    <DiagramFigure
      id="naloxone-diagram"
      title="Naloxone"
      description="Naloxone: labelled teaching figure showing the structures, relationships and key values FRCA and FFICM candidates need to recognise and explain for this topic."
    >
