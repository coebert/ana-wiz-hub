...
const factors: Factor[] = [
  ...
  // Extrinsic
  { id: "tf-vii", label: "TF + VII → TF·VIIa", pathway: "extrinsic", detail: "Tissue factor (TF/thromboplastin) from subendothelium + damaged cells binds VII → initiates coagulation in vivo. TF·VIIa activates BOTH X and IX. Factor VII has shortest half-life (6h) — first to fall with warfarin/liver failure. This is the PRIMARY initiator of coagulation. Note: the TF·VIIa complex itself is not a target of any commonly used clinical anticoagulant (warfarin lowers hepatic synthesis of factor VII — see factor II/VII/IX/X nodes — rather than blocking TF·VIIa enzymatic activity).", drugs: [], cellPhase: ["initiation"] },
...
const CoagulationCascadeDiagram = () => {
  ...
  return (
    <DiagramFigure
      ...
      description="Coagulation cascade: labelled teaching figure showing the structures, relationships and key values FRCA and FFICM candidates need to recognise and explain for this topic."
    >
              <div className="mb-8">
        <div className="mb-3">
