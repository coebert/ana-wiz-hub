...
const InotropeSignallingDiagram = () => {
  ...
  return (
    <DiagramFigure
      id="inotrope-signalling-diagram"
      title="Inotrope signalling"
      description="Auto-generated wrapper for the Inotrope signalling anatomical/physiological diagram. Review and replace with a specific, curriculum-aligned summary of what learners should take from the figure."
    >
