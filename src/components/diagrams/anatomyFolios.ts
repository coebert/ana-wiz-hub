...
export const headNeckFolio: CorPictumFolioData = {
  ...
  plates: [
    ...
    },
    {
      ...
      labels: [
        { english: "Cricoid cartilage", note: "Only complete cartilaginous ring; landmark for cricoid pressure (Sellick) and front-of-neck access." },
        { english: "Trachea", note: "Begins at cricoid (C6); C-shaped rings anteriorly, membranous trachealis posteriorly." },
        { english: "Oesophagus", note: "Posterior to trachea, deviated slightly left at C6 — collapsed in the cadaver, distensible in life." },
        { english: "Thyroid gland", note: "Two lobes wrap antero-laterally around trachea; isthmus crosses rings 2–4 (encountered in tracheostomy)." },
        { english: "Recurrent laryngeal nerve", note: "Lies in the tracheo-oesophageal groove — vulnerable in thyroid surgery; bilateral palsy → stridor." },
        { english: "Common carotid artery", note: "Bifurcates higher (C4); pulsation lateral to cricoid is the landmark for posterior IJV approach." },
        { english: "Internal jugular vein", note: "Lateral and slightly anterior to carotid within the carotid sheath — target for central venous access." },
        { english: "Vagus nerve (CN X)", note: "Posterior to and between IJV and carotid within the sheath — at risk during deep cervical block." },
        { english: "Carotid sheath", note: "Investing fascia enclosing carotid, IJV and vagus; defines the safe US-guided needling plane for IJV CVC." },
        { english: "Sternocleidomastoid", note: "Two heads (sternal, clavicular) — apex of triangle is the surface landmark for landmark IJV cannulation." },
        { english: "Strap muscles (sternohyoid/sternothyroid/omohyoid)", note: "Anterior to thyroid; retracted during tracheostomy and thyroid surgery." },
        { english: "Anterior scalene", note: "Phrenic nerve descends on its anterior surface; brachial plexus emerges between anterior and middle scalene." },
        { english: "Middle and posterior scalene", note: "Form the lateral wall of the interscalene groove — target for interscalene brachial plexus block." },
        { english: "Phrenic nerve (C3,4,5)", note: "On anterior surface of anterior scalene — paralysed in ~100% of interscalene blocks; avoid bilateral block." },
        { english: "Brachial plexus trunks", note: "Between anterior and middle scalene — superior, middle, inferior trunks visible at C5/6/7 level." },
        { english: "Vertebral artery", note: "Ascends through the transverse foramen of C6 (and above); inadvertent injection during stellate block → seizure." },
        { english: "Chassaignac's tubercle (anterior tubercle of C6)", note: "Most prominent anterior cervical tubercle — bony landmark for stellate ganglion block (anterior paratracheal approach)." },
        { english: "C6 vertebral body", note: "Cricoid lies anterior to the C6 body — the surface-to-skeletal correlation that defines this section." },
        { english: "Spinal cord", note: "Cervical enlargement at C5–T1; injury here → tetraplegia, diaphragmatic sparing depends on lesion above C3." },
        { english: "Prevertebral muscles (longus colli/capitis)", note: "Lie on the anterior vertebral body — covered by prevertebral fascia; plane for retropharyngeal abscess spread." },
        { english: "Investing layer of deep cervical fascia", note: "Encircles the neck deep to platysma; splits to enclose SCM and trapezius." },
        { english: "Pretracheal fascia", note: "Encloses thyroid, trachea, oesophagus; continuous inferiorly with the fibrous pericardium." },
        { english: "Prevertebral fascia", note: "Covers prevertebral muscles and scalenes; extends laterally as the axillary sheath around the brachial plexus." },
        { english: "Trapezius", note: "Posterolateral; forms the posterior border of the posterior triangle. Accessory nerve (CN XI) runs on its deep surface." },
      ],
      curriculumLinks: [
